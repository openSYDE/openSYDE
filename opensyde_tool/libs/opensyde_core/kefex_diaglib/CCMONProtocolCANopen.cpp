...
//CANopen constants
static const uint32 NMT_ZERO_ID      =    0U;
static const uint32 SYNC_ID          =  128U;
static const uint32 EMCY_AREA_LOW    =  129U;
static const uint32 EMCY_AREA_HIGH   =  256U;
...
static const uint32 SDO_RX_AREA_HIGH = 1664U;
static const uint32 GUARD_AREA_LOW   = 1793U;
static const uint32 GUARD_AREA_HIGH  = 1920U;
static const uint32 SERVER_BASE_ID   = 1408U;
static const uint32 CLIENT_BASE_ID   = 1536U;

static const uint8 CS_START_NODE           =   1U;
static const uint8 CS_STOP_NODE            =   2U;
static const uint8 CS_ENTER_PREOPERATIONAL = 128U;
static const uint8 CS_RESET_NODE           = 129U;
static const uint8 CS_RESET_COMM           = 130U;

static const uint8 CCS_INIT_UPLOAD      = 0x40U;
static const uint8 SCS_INIT_UPLOAD      = 0x40U;
static const uint8 CCS_SEGMENT_UPLOAD   = 0x60U;
static const uint8 SCS_SEGMENT_UPLOAD   = 0x00U;
static const uint8 CCS_INIT_DOWNLOAD    = 0x20U;
static const uint8 SCS_INIT_DOWNLOAD    = 0x60U;
static const uint8 CCS_SEGMENT_DOWNLOAD = 0x00U;
static const uint8 SCS_SEGMENT_DOWNLOAD = 0x20U;
static const uint8 ABORT_DOMAIN         = 0x80U;

static const uint32 SDO_ERROR_TOGGLE_BIT_NOT_ALTERNATED = 0x05030000U;
static const uint32 SDO_ERROR_TIMEOUT                   = 0x05040000U;
static const uint32 SDO_ERROR_INVALID_COMMAND_SPCIFIER  = 0x05040001U;
static const uint32 SDO_ERROR_INVALID_BLOCK_SIZE        = 0x05040002U;
static const uint32 SDO_ERROR_INVALID_SEQUENCE_NUMBER   = 0x05040003U;
static const uint32 SDO_ERROR_CRC_ERROR                 = 0x05040004U;
static const uint32 SDO_ERROR_OUT_OF_MEMORY             = 0x05040005U;
static const uint32 SDO_ERROR_UNSUPPORTED_ACCESS        = 0x06010000U;
static const uint32 SDO_ERROR_READING_A_WO_OBJECT       = 0x06010001U;
static const uint32 SDO_ERROR_WRITING_AN_RO_OBJECT      = 0x06010002U;
static const uint32 SDO_ERROR_OBJECT_DOES_NOT_EXIST     = 0x06020000U;
static const uint32 SDO_ERROR_OBJECT_CANNOT_BE_MAPPED   = 0x06020041U;
static const uint32 SDO_ERROR_MAPPING_OVERFLOW          = 0x06040042U;
static const uint32 SDO_ERROR_PARAMETER_INCOMPATIBLE    = 0x06040043U;
static const uint32 SDO_ERROR_INTERNAL_INCOMPATIBILITY  = 0x06040047U;
static const uint32 SDO_ERROR_HARDWARE_ERROR            = 0x06060000U;
static const uint32 SDO_ERROR_LENGTH_DOES_NOT_MATCH     = 0x06070010U;
static const uint32 SDO_ERROR_LENGTH_TOO_HIGH           = 0x06070012U;
static const uint32 SDO_ERROR_LENGTH_TOO_LOW            = 0x06070013U;
static const uint32 SDO_ERROR_SUBINDEX_DOES_NOT_EXIST   = 0x06090011U;
static const uint32 SDO_ERROR_VALUE_RANGE_EXCEEDED      = 0x06090030U;
static const uint32 SDO_ERROR_VALUE_TOO_HIGH            = 0x06090031U;
static const uint32 SDO_ERROR_VALUE_TOO_LOW             = 0x06090032U;
static const uint32 SDO_ERROR_MAX_VALUE_LT_MIN_VALUE    = 0x06090036U;
static const uint32 SDO_ERROR_GENERAL_ERROR             = 0x08000000U;
static const uint32 SDO_ERROR_APPLICATION_STORAGE       = 0x08000020U;
static const uint32 SDO_ERROR_LOCAL_CONTROL             = 0x08000021U;
static const uint32 SDO_ERROR_DEVICE_STATE              = 0x08000022U;
static const uint32 SDO_ERROR_DYNAMIC_OD_ERROR          = 0x08000023U;
...
C_SCLString C_CMONProtocolCANopen::MessageToString(const T_STWCAN_Msg_RX & orc_Msg) const
{
   ...
   if ((orc_Msg.u32_ID >= GUARD_AREA_LOW) && (orc_Msg.u32_ID < GUARD_AREA_HIGH)) //Nodeguarding / Heartbeat / Bootup
   {
      ...
      {
         c_Text = "HB/Guard " +
              m_GetByteAsStringFormat(static_cast<uint8>(orc_Msg.u32_ID - (GUARD_AREA_LOW - 1))) + " : TGL:"
         ...
         case 127:
            ...
            break;
         default:
            c_Help = m_GetByteAsStringFormat(static_cast<uint8>(orc_Msg.au8_Data[0] & 0x7FU));
            break;
         }
      ...
      {
         c_Text = "Guard RQ " + m_GetByteAsStringFormat(static_cast<uint8>(orc_Msg.u32_ID - (GUARD_AREA_LOW - 1)));
      }
   }
   ...
   {
      c_Text = "EMCY NODE " + m_GetByteAsStringFormat(static_cast<uint8>(orc_Msg.u32_ID - (EMCY_AREA_LOW - 1))) + ":";
      if (orc_Msg.u8_DLC == 0)
      {
   ...
   if ((orc_Msg.u32_ID > SERVER_BASE_ID) && (orc_Msg.u32_ID < SDO_RX_AREA_HIGH))
   {
      ...
      {
         c_Help = "SDO SERVER " + m_GetByteAsStringFormat(static_cast<uint8>(orc_Msg.u32_ID - SERVER_BASE_ID))+": ";
            ...
            case SCS_INIT_UPLOAD     :
               ...
               if ((orc_Msg.au8_Data[0] & 0x02U) == 0x02U)
               {
                  ...
                  if ((orc_Msg.au8_Data[0] & 0x01U) == 0x01U) //size is indicated
                  {
                     ...
                     c_Help2 += ("Size:" + m_GetByteAsStringFormat(static_cast<uint8>(u32_Size)) + " ");
                  }
                  else
                  {
                     u32_Size = 4;
                  ...
                  c_Help2 += "DB: ";
                  for (j = 0; j < static_cast<sint32>(u32_Size); j++)
                  {
      ...
      {
         c_Help = "SDO CLIENT " + m_GetByteAsStringFormat(static_cast<uint8>(orc_Msg.u32_ID - CLIENT_BASE_ID)) + ": ";
         switch (orc_Msg.au8_Data[0] & 0xE0U)
         {
