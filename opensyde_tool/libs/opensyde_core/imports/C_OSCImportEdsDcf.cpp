   ...
   if (TGL_FileExists(orc_FilePath) == true)
   {
      ...
      if (s32_Retval == C_NO_ERR)
      {
         ...
         if (c_Dictionary.LoadFromFile(orc_FilePath) == C_NO_ERR)
         {
            ...
            {
               u32_StartId = C_OSCCanOpenObjectDictionary::hu16_OBJECT_DICTIONARY_START_INDEX_TPDO;
            }
            else
            {
               u32_StartId = C_OSCCanOpenObjectDictionary::hu16_OBJECT_DICTIONARY_START_INDEX_RPDO;
            }
                                               ...
                                               bool & orq_DefaultMinMax)
{
   ...
   if (pc_COSignalObject != NULL)
   {
      ...
      //Min & max
      if (mh_CalcMinMax(pc_COSignalObject, orc_CurDataPoolSignal, orc_CurSignal.u16_ComBitLength,
                                           ...
                                           std::vector<std::vector<stw_scl::C_SCLString> > & orc_InvalidImportMessages)
{
        ...
        ++u32_ItMessage)
   {
      ...
      if (pc_COMessageMainObject != NULL)
      {
         ...
         if (pc_COMessageCOBIDObject != NULL)
         {
                                   ...
                                   u32_CobId, &q_CobIdIncludesNodeId) == C_NO_ERR)
            {
               ...
               if ((u32_CobId & 0x80000000UL) == 0UL)
               {
                  s32_Retval = C_OSCImportEdsDcf::mh_ParseMessageContent(ou32_StartingId, ou8_NodeId, orc_COObjects,
                                                                         ...
                                                                         *pc_COMessageMainObject, u32_ItMessage,
               ...
               else
               {
                  ...
                  else
                  {
                     ...
                     mh_AddUserMessage(ou32_StartingId + u32_ItMessage, "COB-ID used by PDO",
                                       c_Stream.str().c_str(), C_OSCCanOpenObjectDictionary::hu8_OBJECT_DICTIONARY_COB_ID_SUB_INDEX,
                                       true);
                  }
               }
            }
            else
            {
               mh_AddUserMessage(ou32_StartingId + u32_ItMessage, "COB-ID used by PDO",
                                 ...
                                 C_OSCCanOpenObjectDictionary::hu8_OBJECT_DICTIONARY_COB_ID_SUB_INDEX, true);
               s32_Retval = C_CONFIG;
            }
         }
         else
         {
            mh_AddUserMessage(ou32_StartingId + u32_ItMessage, "COB-ID used by PDO",
                              "does not exist", C_OSCCanOpenObjectDictionary::hu8_OBJECT_DICTIONARY_COB_ID_SUB_INDEX,
                              true);
            s32_Retval = C_CONFIG;
         }
      }
                                                 ...
                                                 const bool oq_CobIdIncludesNodeId)
{
   ...
   if (s32_Retval == C_NO_ERR)
   {
      ...
      if (s32_Retval != C_NO_ERR)
      {
         ...
         s32_Retval = C_NO_ERR;
         mh_AddUserMessage(ou32_StartingId + ou32_ItMessage, "",
                             ...
                             u32_TransmissionType) == C_NO_ERR)
      {
         if ((u32_TransmissionType >= 1UL) && (u32_TransmissionType <= 0xF0UL))
         {
            ...
            mh_AddUserMessage(ou32_StartingId + ou32_ItMessage, "Transmission type",
                              ...
                              C_OSCCanOpenObjectDictionary::hu8_OBJECT_DICTIONARY_TRANSMISSION_TYPE_SUB_INDEX, false,
                              &orc_CurMessages);
         }
         else if ((u32_TransmissionType == 0xFCUL) || (u32_TransmissionType == 0xFDUL))
         {
            mh_AddUserMessage(ou32_StartingId + ou32_ItMessage, "Transmission type",
                              "not supported",
                              C_OSCCanOpenObjectDictionary::hu8_OBJECT_DICTIONARY_TRANSMISSION_TYPE_SUB_INDEX, true);
            s32_Retval = C_CONFIG;
         }
         else
         {
      ...
      if (q_UseDefault == true)
      {
         ...
         if (orc_Message.e_TxMethod != C_OSCCanMessage::eTX_METHOD_ON_EVENT)
         {
            mh_AddUserMessage(ou32_StartingId + ou32_ItMessage, "Event-timer",
                              ...
                              C_SCLString::IntToStr(
                                 orc_Message.u32_TimeoutMs) + "ms", C_OSCCanOpenObjectDictionary::hu8_OBJECT_DICTIONARY_EVENT_TIMER_SUB_INDEX, false,
                              &orc_CurMessages);
         }
         else
         {
            mh_AddUserMessage(ou32_StartingId + ou32_ItMessage, "Event-timer",
                              ...
                              C_OSCCanOpenObjectDictionary::hu8_OBJECT_DICTIONARY_EVENT_TIMER_SUB_INDEX, false,
                              &orc_CurMessages);
                             ...
                             u32_InhibitTime) == C_NO_ERR)
      {
         ...
         if ((u32_InhibitTime % 10) != 0)
         {
            mh_AddUserMessage(ou32_StartingId + ou32_ItMessage, "Inhibit-time",
                              ...
                              C_OSCCanOpenObjectDictionary::hu8_OBJECT_DICTIONARY_INHIBIT_TIME_SUB_INDEX, false,
                              &orc_CurMessages);
         }
      }
      else
                                          ...
                                          std::vector<C_SCLString> & orc_ImportMessages)
{
   ...
   if ((pc_COMessageMappingObject != NULL) && (pc_COMessageMappingObject->u8_NumSubs > 0U))
   {
      ...
      if (u32_MappingCount <= 0x40U)
      {
         ...
         for (uint32 u32_ItSignal = 0U; (u32_ItSignal < u32_MappingCount) && (s32_Retval == C_NO_ERR); ++u32_ItSignal)
         {
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCImportEdsDcf::mh_CalcMinMax(const C_OSCCanOpenObject * const opc_COSignalObject,
