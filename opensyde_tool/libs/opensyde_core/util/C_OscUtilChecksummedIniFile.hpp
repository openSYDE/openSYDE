...
/*!
   ...
   \class       stw::opensyde_core::C_OscUtilChecksummedIniFile
   \brief       Checksummed INI file class
   ...
   ~~~{.cpp}
   C_OscUtilChecksummedIniFile c_File("myfile.ini"); //open file
...
*/
//----------------------------------------------------------------------------------------------------------------------
#ifndef C_OSCUTILCHECKSUMMEDINIFILE_HPP
...
class C_OscUtilChecksummedIniFile :
