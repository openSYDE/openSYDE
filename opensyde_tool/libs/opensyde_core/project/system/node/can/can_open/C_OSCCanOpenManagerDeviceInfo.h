...
public:
   ...
   C_OSCCanOpenObjectDictionary c_EDSFileContent; ///< Content of loaded EDS file, parsed for GUI usage
   bool q_DeviceOptional;                         ///< Flag for CANopen manager to consider this device
   ///< optional
