...
*/
//----------------------------------------------------------------------------------------------------------------------
#ifndef C_SDNDEDATAPOOLLISTDATASETMODEL_H
#define C_SDNDEDATAPOOLLISTDATASETMODEL_H
...
class C_SdNdeDataPoolListDataSetModel :
...
public:
   ...
   explicit C_SdNdeDataPoolListDataSetModel(QObject * const opc_Parent = NULL);
