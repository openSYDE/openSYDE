   ...
   mq_IndexValid(false)
{
   ...
   for (s32_Counter = 0; s32_Counter < 3; ++s32_Counter)
   {
      ...
      connect(this->mapc_Selectors[s32_Counter], &C_SdNdeDataPoolSelectorWidget::SigWidgetFocused,
              this, &C_SdNdeDataPoolViewWidget::m_SubWidgetFocused);

      connect(this->mapc_Selectors[s32_Counter], &C_SdNdeDataPoolSelectorWidget::SigChanged,
              this, &C_SdNdeDataPoolViewWidget::SigChanged);
      connect(this->mapc_Selectors[s32_Counter], &C_SdNdeDataPoolSelectorWidget::SigUpdateLists,
              this, &C_SdNdeDataPoolViewWidget::SigUpdateLists);

      connect(this->mapc_Selectors[s32_Counter], &C_SdNdeDataPoolSelectorWidget::SigNoDataPoolSelected,
              this, &C_SdNdeDataPoolViewWidget::m_NoDataPoolSelected);
   }

   connect(this->mpc_Ui->pc_BtnMinMaxDbSelector, &stw_opensyde_gui_elements::C_OgePubIconOnly::clicked,
           this, &C_SdNdeDataPoolViewWidget::m_MinMaxClicked);
   connect(this->mpc_Ui->pc_WidgetDpCom, &C_SdNdeDataPoolSelectorWidget::SigErrorCheck, this,
           &C_SdNdeDataPoolViewWidget::m_ErrorCheck);
   connect(this->mpc_Ui->pc_WidgetDpDiag, &C_SdNdeDataPoolSelectorWidget::SigErrorCheck, this,
           &C_SdNdeDataPoolViewWidget::m_ErrorCheck);
   connect(this->mpc_Ui->pc_WidgetDpNvm, &C_SdNdeDataPoolSelectorWidget::SigErrorCheck, this,
           &C_SdNdeDataPoolViewWidget::m_ErrorCheck);
}
...
void C_SdNdeDataPoolViewWidget::CheckDataPoolInteraction(void) const
{
   ...
   {
      this->mapc_Selectors[s32_Counter]->CheckDataPoolInteraction();
   }
}
