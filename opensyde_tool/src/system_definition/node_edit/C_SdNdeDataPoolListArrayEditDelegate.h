...
*/
//-----------------------------------------------------------------------------
#ifndef C_SDNDEDATAPOOLLISTARRAYEDITDELEGATE_H
#define C_SDNDEDATAPOOLLISTARRAYEDITDELEGATE_H
...
class C_SdNdeDataPoolListArrayEditDelegate :
   public QStyledItemDelegate
{
public:
   C_SdNdeDataPoolListArrayEditDelegate(QObject * const opc_Parent = NULL);
   ...
   virtual void setModelData(QWidget * const opc_Editor, QAbstractItemModel * const opc_Model,
                             const QModelIndex & orc_Index) const;
   //lint -restore
   void SetModel(const C_SdNdeDataPoolListArrayEditModel * const opc_Value);

private:
   const C_SdNdeDataPoolListArrayEditModel * mpc_Model;
