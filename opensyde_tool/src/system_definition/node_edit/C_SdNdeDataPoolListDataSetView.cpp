   ...
   mq_AllowMoveRight(true)
{
   ...
   C_OgeWiUtil::h_ApplyStylesheetProperty(this->verticalScrollBar(), "C_SdNdeDataPoolListDataSetView", true);
   C_OgeWiUtil::h_ApplyStylesheetProperty(this->horizontalScrollBar(), "C_SdNdeDataPoolListDataSetView", true);
   ...
   //Corner button label
   {
      ...
      connect(
         ...
         &C_SdNdeDataPoolListDataSetView::m_UpdateCornerButton);
      connect(
...
void C_SdNdeDataPoolListDataSetView::dropEvent(QDropEvent * const opc_Event)
{
   ...
   C_SdNdeDataPoolListDataSetView * const pc_SourceTable =
      dynamic_cast<C_SdNdeDataPoolListDataSetView * const>(opc_Event->source());
   ...
   if (pc_SourceTable != NULL)
   {
      ...
      if (pc_MimeData != NULL)
      {
         if (this->mpc_ModelViewManager != NULL)
         {
            C_SdNdeDataPoolListDataSetModel * const pc_Model = this->mpc_ModelViewManager->GetDataSetModel(
                                                      ...
                                                      const QItemSelection & orc_Deselected)
{
   ...
   c_SelectedIndices = C_SdNdeDataPoolUtil::h_ConvertVector(this->selectedIndexes(), false);
