...
*/
//----------------------------------------------------------------------------------------------------------------------
C_SdNdeCoOverviewDelegate::C_SdNdeCoOverviewDelegate(QObject * const opc_Parent) :
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeCoOverviewDelegate::paint(QPainter * const opc_Painter, const QStyleOptionViewItem & orc_Option,
...
*/
//----------------------------------------------------------------------------------------------------------------------
bool C_SdNdeCoOverviewDelegate::SetHoveredRow(const stw_types::sint32 & ors32_Value)
{
   bool q_Retval;
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeCoOverviewDelegate::SetModel(const QAbstractTableModel * const opc_Value)
{
