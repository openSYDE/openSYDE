...
#include "ui_C_SdNdeDataPoolListHeaderWidget.h"
   ...
   mq_DataSetError(false)
{
   ...
   connect(this->mpc_Ui->pc_PushButtonFullScreen, &stw_opensyde_gui_elements::C_OgePubIconOnly::pressed, this,
           &C_SdNdeDataPoolListHeaderWidget::m_HandleFocus);
   connect(this->mpc_Ui->pc_TextEditComment, &stw_opensyde_gui_elements::C_OgeTedListHeaderBase::SigFocus, this,
           &C_SdNdeDataPoolListHeaderWidget::m_HandleTextEditFocus);
...
void C_SdNdeDataPoolListHeaderWidget::PopUp(void)
{
   ...
   //Connect
   connect(this, &C_SdNdeDataPoolListHeaderWidget::SigUpdated, pc_PopUp, &C_SdNdeDataPoolListPopUp::UpdateHeader);
   connect(pc_PopUp, &C_SdNdeDataPoolListPopUp::SigSave, this, &C_SdNdeDataPoolListHeaderWidget::SigSave);
   //Resize
   ...
   if (c_Dialog != NULL)
   {
      disconnect(pc_PopUp, &C_SdNdeDataPoolListPopUp::SigSave, this, &C_SdNdeDataPoolListHeaderWidget::SigSave);
      ...
      {
         //Disconnect
         disconnect(this, &C_SdNdeDataPoolListHeaderWidget::SigUpdated, pc_PopUp,
                    &C_SdNdeDataPoolListPopUp::UpdateHeader);
         //Check error
         Q_EMIT this->SigErrorChange();
         //Reload
         this->m_UpdateUi();
...
void C_SdNdeDataPoolListHeaderWidget::m_HandleTextEditFocus(const bool oq_Active)
{
   if (oq_Active == true)
   {
      m_HandleWidgetResize(C_SdNdeDataPoolListHeaderWidget::mhu32_HeaderExpandedHeight);
   }
   else
   {
      m_HandleWidgetResize(C_SdNdeDataPoolListHeaderWidget::mhu32_HeaderHeight);
   }
}
      ...
      if (this->mpc_UndoManager != NULL)
      {
         ...
         this->mpc_UndoManager->DoChangeListData(this->mu32_NodeIndex, this->mu32_DataPoolIndex,
                                                 dynamic_cast<C_SdNdeDataPoolListsTreeWidget * const>(this->
                                                                                                      mpc_TreeWidget),
                                                 this->mu32_ListIndex, c_Data, C_SdNdeDataPoolUtil::eLIST_NAME);
      }
   ...
   if (this->mq_InitActive == false)
   {
      ...
      if (this->mpc_UndoManager != NULL)
      {
         ...
         this->mpc_UndoManager->DoChangeListData(this->mu32_NodeIndex, this->mu32_DataPoolIndex,
                                                 dynamic_cast<C_SdNdeDataPoolListsTreeWidget * const>(this->
                                                                                                      mpc_TreeWidget),
                                                 this->mu32_ListIndex, c_Data, C_SdNdeDataPoolUtil::eLIST_COMMENT);
      }
   }
}
   ...
   if (this->mq_InitActive == false)
   {
      ...
      if (this->mpc_UndoManager != NULL)
      {
         ...
         this->mpc_UndoManager->DoChangeListData(this->mu32_NodeIndex, this->mu32_DataPoolIndex,
                                                 dynamic_cast<C_SdNdeDataPoolListsTreeWidget * const>(this->
                                                                                                      mpc_TreeWidget),
                                                 this->mu32_ListIndex, c_Data, C_SdNdeDataPoolUtil::eLIST_SIZE);
      }
      Q_EMIT this->SigUpdateAddress();
   }
}
...
void C_SdNdeDataPoolListHeaderWidget::m_OpenDataSetEdit(void)
{
   ...
   {
      C_SdNdeDataPoolListDataSetWidget * const pc_DataSetWidget = new C_SdNdeDataPoolListDataSetWidget(*c_Dialog,
                                                                                                       this->mu32_NodeIndex, this->mu32_DataPoolIndex,
                                                                                                       this->mu32_ListIndex);
