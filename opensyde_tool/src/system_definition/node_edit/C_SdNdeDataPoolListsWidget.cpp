...
#include "ui_C_SdNdeDataPoolListsWidget.h"
   ...
   mu32_LastKnownTableSelectionCount(0)
{
   ...
   connect(this->mpc_Ui->pc_PushButtonPaste, &QPushButton::clicked, this->mpc_Ui->pc_TreeWidget,
           &C_SdNdeDataPoolListsTreeWidget::Paste);
   connect(this->mpc_Ui->pc_TreeWidget, &C_SdNdeDataPoolListsTreeWidget::SigErrorChange, this,
           &C_SdNdeDataPoolListsWidget::m_HandleErrorChange);
   connect(this->mpc_Ui->pc_TreeWidget, &C_SdNdeDataPoolListsTreeWidget::SigSizeChange, this,
           &C_SdNdeDataPoolListsWidget::m_HandleSizeChange);
   connect(this->mpc_Ui->pc_TreeWidget, &C_SdNdeDataPoolListsTreeWidget::SigSelectionChanged, this,
           &C_SdNdeDataPoolListsWidget::m_HandleSelection);
   //lint -e{64,918,1025,1703} Qt interface
   connect(this->mpc_Ui->pc_TreeWidget, &C_SdNdeDataPoolListsTreeWidget::SigButtonChange, this,
           &C_SdNdeDataPoolListsWidget::m_HandleButtonChange);
   connect(this->mpc_Ui->pc_TreeWidget, &C_SdNdeDataPoolListsTreeWidget::SigChanged, this,
           &C_SdNdeDataPoolListsWidget::m_HandleChanged);
   connect(this->mpc_Ui->pc_TreeWidget, &C_SdNdeDataPoolListsTreeWidget::SigSave, this,
           &C_SdNdeDataPoolListsWidget::SigSave);
   connect(this->mpc_Ui->pc_TreeWidget, &C_SdNdeDataPoolListsTreeWidget::SigSaveAs, this,
           &C_SdNdeDataPoolListsWidget::SigSaveAs);
