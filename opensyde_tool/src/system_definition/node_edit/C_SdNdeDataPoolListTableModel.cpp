...
C_SdNdeDataPoolListTableModel::C_SdNdeDataPoolListTableModel(QObject * const opc_Parent) :
   ...
   mu32_ListIndex(0)
{
   connect(&this->mc_ErrorManager, &C_SdNdeDataPoolListTableErrorManager::SigErrorChange, this,
                                                   ...
                                                   const sintn osn_Role) const
{
   ...
   if (oe_Orientation == Qt::Orientation::Horizontal)
   {
      ...
      const C_SdNdeDataPoolListTableModel::E_Columns e_Col = ColumnToEnum(osn_Section, &s32_DataSetIndex);
...
QVariant C_SdNdeDataPoolListTableModel::data(const QModelIndex & orc_Index, const sintn osn_Role) const
{
   ...
   {
      sint32 s32_DataSetIndex;
      const C_SdNdeDataPoolListTableModel::E_Columns e_Col = ColumnToEnum(orc_Index.column(), &s32_DataSetIndex);
         ...
         if (orc_Index.row() >= 0)
         {
            ...
            if ((pc_OSCElement != NULL) && (pc_UIElement != NULL))
            {
               ...
               case eMIN:
                  if (pc_UIElement->q_InterpretAsString == true)
                  {
                     c_Retval = C_SdNdeDataPoolUtil::h_ConvertToString(pc_OSCElement->c_MinValue);
                  }
                  else
                  {
                     ...
                     else
                     {
                        ...
                        {
                           QString c_Final;
                           C_SdNdeDataPoolContentUtil::h_GetValuesAsScaledCombinedString(pc_OSCElement->c_MinValue,
                                                                                         pc_OSCElement->f64_Factor,
                                                                                         pc_OSCElement->f64_Offset,
                                                                                         c_Final);
                           c_Retval = c_Final;
               ...
               case eMAX:
                  if (pc_UIElement->q_InterpretAsString == true)
                  {
                     c_Retval = C_SdNdeDataPoolUtil::h_ConvertToString(pc_OSCElement->c_MaxValue);
                  }
                  else
                  {
                     if ((pc_OSCElement->GetArray() == false) || (pc_UIElement->q_AutoMinMaxActive == true))
                     ...
                     else
                     {
                        ...
                        {
                           QString c_Final;
                           C_SdNdeDataPoolContentUtil::h_GetValuesAsScaledCombinedString(pc_OSCElement->c_MaxValue,
                                                                                         pc_OSCElement->f64_Factor,
                                                                                         pc_OSCElement->f64_Offset,
                                                                                         c_Final);
                           c_Retval = c_Final;
               ...
               case eDATA_SET:
                  if (pc_UIElement->q_InterpretAsString == true)
                  {
                     if (s32_DataSetIndex >= 0)
                     {
                        ...
                        {
                           QString c_Result =
                              C_SdNdeDataPoolUtil::h_ConvertToString(pc_OSCElement->c_DataSetValues[u32_DataSet]);
                           if (osn_Role == static_cast<sintn>(Qt::DisplayRole))
                           {
                              c_Result += "\\0";
                           }
               ...
               case eACCESS:
                  ...
                  {
                     c_Retval = C_SdNdeDataPoolUtil::h_ConvertElementAccessToString(pc_OSCElement->e_Access);
                  }
                  break;
               case eDATA_SIZE:
   ...
   if (data(orc_Index, osn_Role) != orc_Value)
   {
      if (orc_Index.row() >= 0)
      {
         if (osn_Role == static_cast<sintn>(Qt::EditRole))
         {
            const uint32 u32_Index = static_cast<uint32>(orc_Index.row());
            sint32 s32_DataSetIndex;
            const C_SdNdeDataPoolListTableModel::E_Columns e_Col =
            ...
            case eMIN:
               Q_EMIT this->SigDataChange(this->mu32_NodeIndex, this->mu32_DataPoolIndex,
                                          this->mu32_ListIndex,
                                          u32_Index, orc_Value,
                                          C_SdNdeDataPoolUtil::E_ElementDataChangeType::eELEMENT_MIN,
                                          0, 0);
               q_Retval = true;
               break;
            case eMAX:
               Q_EMIT this->SigDataChange(this->mu32_NodeIndex, this->mu32_DataPoolIndex,
                                          this->mu32_ListIndex,
                                          u32_Index, orc_Value,
                                          C_SdNdeDataPoolUtil::E_ElementDataChangeType::eELEMENT_MAX,
                                          0, 0);
               q_Retval = true;
               break;
            case eFACTOR:
            ...
            case eDATA_SET:
               Q_EMIT this->SigDataChange(this->mu32_NodeIndex, this->mu32_DataPoolIndex,
                                          this->mu32_ListIndex,
                                          u32_Index, orc_Value,
                                          C_SdNdeDataPoolUtil::E_ElementDataChangeType::eELEMENT_DATA_SET,
                                          0, s32_DataSetIndex);
               q_Retval = true;
               break;
            case eACCESS:
            ...
            if (orc_Value.type() == QVariant::Int)
            {
               ...
               case eAUTO_MIN_MAX:
                  Q_EMIT this->SigDataChange(this->mu32_NodeIndex, this->mu32_DataPoolIndex,
                                             ...
                                             C_SdNdeDataPoolUtil::E_ElementDataChangeType::eELEMENT_AUTO_MIN_MAX,
                                             0, 0);
                  q_Retval = true;
                  break;
               case eEVENT_CALL:
                  Q_EMIT this->SigDataChange(this->mu32_NodeIndex, this->mu32_DataPoolIndex,
                                             this->mu32_ListIndex,
                                             u32_Index, QVariant(q_Val),
                                             C_SdNdeDataPoolUtil::E_ElementDataChangeType::eELEMENT_EVENT_CALL,
                                             0, 0);
                  q_Retval = true;
                  break;
               default:
...
const
{
   C_SdNdeDataPoolListTableModel::E_Columns e_Retval;
...
QMimeData * C_SdNdeDataPoolListTableModel::mimeData(const QModelIndexList & orc_Indices) const
{
   ...
   if (orc_Indices.size() > 0)
   {
      if (this->mimeTypes().size() > 2)
      {
         ...
         {
            std::vector<uint32> c_Rows = C_SdNdeDataPoolUtil::h_ConvertVector(orc_Indices, true);
            QString c_String;
                                                     ...
                                                     const sint32 & ors32_DataSetIndex)
{
   ...
   {
   case C_SdNdeDataPoolUtil::E_ElementDataChangeType::eELEMENT_ACCESS:
      s32_Column = this->EnumToColumn(C_SdNdeDataPoolListTableModel::eACCESS);
      break;
   case C_SdNdeDataPoolUtil::E_ElementDataChangeType::eELEMENT_NAME:
      s32_Column = this->EnumToColumn(C_SdNdeDataPoolListTableModel::eNAME);
      q_ErrorChange = true;
      break;
   case C_SdNdeDataPoolUtil::E_ElementDataChangeType::eELEMENT_COMMENT:
      s32_Column = this->EnumToColumn(C_SdNdeDataPoolListTableModel::eCOMMENT);
      break;
   case C_SdNdeDataPoolUtil::E_ElementDataChangeType::eELEMENT_AUTO_MIN_MAX:
      s32_Column = this->EnumToColumn(C_SdNdeDataPoolListTableModel::eAUTO_MIN_MAX);
      q_ErrorChange = true;
      break;
   case C_SdNdeDataPoolUtil::E_ElementDataChangeType::eELEMENT_MAX:
      s32_Column = this->EnumToColumn(C_SdNdeDataPoolListTableModel::eMAX);
      q_ErrorChange = true;
      break;
   case C_SdNdeDataPoolUtil::E_ElementDataChangeType::eELEMENT_MIN:
      s32_Column = this->EnumToColumn(C_SdNdeDataPoolListTableModel::eMIN);
      q_ErrorChange = true;
      break;
   case C_SdNdeDataPoolUtil::E_ElementDataChangeType::eELEMENT_ARRAY:
      s32_Column = this->EnumToColumn(C_SdNdeDataPoolListTableModel::eARRAY_SIZE);
      q_ErrorChange = true;
      Q_EMIT this->SigSizeChangePossible(this->mu32_NodeIndex, this->mu32_DataPoolIndex, this->mu32_ListIndex);
      break;
   case C_SdNdeDataPoolUtil::E_ElementDataChangeType::eELEMENT_DATA_SET:
      s32_Column = this->EnumToColumn(C_SdNdeDataPoolListTableModel::eDATA_SET);
      ...
      q_ErrorChange = true;
      break;
   case C_SdNdeDataPoolUtil::E_ElementDataChangeType::eELEMENT_EVENT_CALL:
      s32_Column = this->EnumToColumn(C_SdNdeDataPoolListTableModel::eEVENT_CALL);
      break;
   case C_SdNdeDataPoolUtil::E_ElementDataChangeType::eELEMENT_FACTOR:
      s32_Column = this->EnumToColumn(C_SdNdeDataPoolListTableModel::eFACTOR);
      break;
   case C_SdNdeDataPoolUtil::E_ElementDataChangeType::eELEMENT_OFFSET:
      s32_Column = this->EnumToColumn(C_SdNdeDataPoolListTableModel::eOFFSET);
      break;
   case C_SdNdeDataPoolUtil::E_ElementDataChangeType::eELEMENT_UNIT:
      s32_Column = this->EnumToColumn(C_SdNdeDataPoolListTableModel::eUNIT);
      break;
   case C_SdNdeDataPoolUtil::E_ElementDataChangeType::eELEMENT_VALUE_TYPE:
      s32_Column = this->EnumToColumn(C_SdNdeDataPoolListTableModel::eVALUE_TYPE);
      q_ErrorChange = true;
      Q_EMIT this->SigSizeChangePossible(this->mu32_NodeIndex, this->mu32_DataPoolIndex, this->mu32_ListIndex);
      break;
   default:
...
bool C_SdNdeDataPoolListTableModel::IsString(const QModelIndex & orc_Index) const
{
   ...
   const QModelIndex c_Index =
      this->index(orc_Index.row(), this->EnumToColumn(C_SdNdeDataPoolListTableModel::eVALUE_TYPE));
