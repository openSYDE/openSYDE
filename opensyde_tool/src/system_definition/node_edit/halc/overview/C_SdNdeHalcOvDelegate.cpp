...
/*!
   ...
   HALC overview drawing delegate
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeHalcOvDelegate::paint(QPainter * const opc_Painter, const QStyleOptionViewItem & orc_Option,
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeHalcOvDelegate::SetModel(const QAbstractTableModel * const opc_Value)
{
