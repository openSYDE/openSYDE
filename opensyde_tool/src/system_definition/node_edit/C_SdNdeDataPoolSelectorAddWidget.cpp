...
#include "ui_C_SdNdeDataPoolSelectorAddWidget.h"
   ...
   mrc_OSCDataPool(orc_OSCDataPool)
{
   ...
   connect(this->mpc_Ui->pc_ComboBoxSharedDatapool,
           ...
           &C_SdNdeDataPoolSelectorAddWidget::m_OnSharedDataPoolChanged);
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeDataPoolSelectorAddWidget::InitStaticNames(void) const
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
bool C_SdNdeDataPoolSelectorAddWidget::GetSelectedSharedDatapool(C_OSCNodeDataPoolId & orc_SharedDatapoolId) const
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeDataPoolSelectorAddWidget::keyPressEvent(QKeyEvent * const opc_KeyEvent)
{
   bool q_CallOrg = true;
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeDataPoolSelectorAddWidget::m_InitFromData(void)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeDataPoolSelectorAddWidget::m_OkClicked(void)
{
   this->mrc_ParentDialog.accept();
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeDataPoolSelectorAddWidget::m_CancelClicked(void)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeDataPoolSelectorAddWidget::m_OnStandAloneChange(void) const
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeDataPoolSelectorAddWidget::m_OnSharedChanged(void) const
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeDataPoolSelectorAddWidget::m_OnSharedDataPoolChanged(void) const
{
       ...
       (rc_SharedDatapools.IsSharedDatapool(c_SelectedDatapoolId, &u32_SharedGroup) == true))
   {
      ...
      tgl_assert(C_SdNdeDataPoolUtil::GetSharedDatapoolGroup(u32_SharedGroup, c_SelectedDatapoolId,
                                                             this->mu32_NodeIndex,
