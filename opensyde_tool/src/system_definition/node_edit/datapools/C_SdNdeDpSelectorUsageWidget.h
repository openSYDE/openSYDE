...
*/
//----------------------------------------------------------------------------------------------------------------------
#ifndef C_SDNDEDPSELECTORUSAGEWIDGET_H
#define C_SDNDEDPSELECTORUSAGEWIDGET_H
...
class C_SdNdeDpSelectorUsageWidget :
   public QWidget
{
   Q_OBJECT

public:
   explicit C_SdNdeDpSelectorUsageWidget(QWidget * const opc_Parent = NULL);
   ~C_SdNdeDpSelectorUsageWidget(void);
