...
*/
//----------------------------------------------------------------------------------------------------------------------
#ifndef C_SDNDEDPLISTTABLEDELEGATE_HPP
#define C_SDNDEDPLISTTABLEDELEGATE_HPP
...
private:
   ...
   int32_t ms32_EditCount;
   int32_t ms32_UndoStartIndex;
   QModelIndex mc_Edit;
   ...
   void m_OnValueTypeChange(const int32_t & ors32_Index);
   void m_OnArraySizeChange(const int32_t & ors32_NewSize);
