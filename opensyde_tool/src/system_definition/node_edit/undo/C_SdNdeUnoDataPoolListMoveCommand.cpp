...
/*! \brief   Default constructor
   ...
   \param[in]     orc_SourceRows            Source rows
   \param[in]     orc_TargetRows            Target rows
...
C_SdNdeUnoDataPoolListMoveCommand::C_SdNdeUnoDataPoolListMoveCommand(const uint32_t & oru32_NodeIndex,
   ...
   mc_SourceRows(orc_SourceRows),
   mc_TargetRows(orc_TargetRows)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeUnoDataPoolListMoveCommand::m_MoveItem(const uint32_t ou32_SourceIndex,
                                                   const uint32_t ou32_TargetIndex) const
{
