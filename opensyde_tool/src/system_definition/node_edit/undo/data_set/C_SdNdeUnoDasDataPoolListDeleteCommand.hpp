...
*/
//----------------------------------------------------------------------------------------------------------------------
#ifndef C_SDNDEUNODASDATAPOOLLISTDELETECOMMAND_HPP
#define C_SDNDEUNODASDATAPOOLLISTDELETECOMMAND_HPP
...
{
public:
   C_SdNdeUnoDasDataPoolListDeleteCommand(const uint32_t & oru32_NodeIndex, const uint32_t & oru32_DataPoolIndex,
