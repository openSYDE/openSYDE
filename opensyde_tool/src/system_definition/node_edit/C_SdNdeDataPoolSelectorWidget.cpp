...
#include "ui_C_SdNdeDataPoolSelectorWidget.h"
   ...
   mq_AllowInteraction(false)
{
   ...
   connect(this->mpc_Ui->pc_PushButtonScrollLeft, &stw_opensyde_gui_elements::C_OgePubIconOnly::clicked,
           this, &C_SdNdeDataPoolSelectorWidget::m_ButtonLeftClicked);
   connect(this->mpc_Ui->pc_PushButtonScrollRight, &stw_opensyde_gui_elements::C_OgePubIconOnly::clicked,
           this, &C_SdNdeDataPoolSelectorWidget::m_ButtonRightClicked);
   connect(this->mpc_Ui->pc_ListWidget, &C_SdNdeDataPoolSelectorListWidget::SigListChanged,
           this, &C_SdNdeDataPoolSelectorWidget::m_UpdateWidget);
   connect(this->mpc_Ui->pc_ListWidget, &C_SdNdeDataPoolSelectorListWidget::SigWidgetFocused,
           this, &C_SdNdeDataPoolSelectorWidget::m_ListFocused);
   connect(this->mpc_Ui->pc_ListWidget, &C_SdNdeDataPoolSelectorListWidget::SigErrorCheck,
           this, &C_SdNdeDataPoolSelectorWidget::m_OnErrorCheck);
   connect(this->mpc_Ui->pc_ListWidget, &C_SdNdeDataPoolSelectorListWidget::SigNoDataPoolSelected,
           this, &C_SdNdeDataPoolSelectorWidget::SigNoDataPoolSelected);
   connect(this->mpc_Ui->pc_PushButtonAdd, &stw_opensyde_gui_elements::C_OgePubIconOnly::clicked,
           this, &C_SdNdeDataPoolSelectorWidget::m_AddNewDatapool);
   connect(this->mpc_Ui->pc_ListWidget, &C_SdNdeDataPoolSelectorListWidget::SigHideOtherToolTips, this,
           &C_SdNdeDataPoolSelectorWidget::HideToolTip);
                                                   ...
                                                   const uint32 ou32_NodeIndex, const bool oq_UsageViewActive)
{
   ...
   if (this->mq_UsageViewActive == true)
   {
      ...
      {
         this->mpc_UsageBar = new C_SdNdeDataPoolSelectorUsageWidget(this);
         connect(this->mpc_UsageBar, &C_SdNdeDataPoolSelectorUsageWidget::SigHideOtherToolTips, this,
                 &C_SdNdeDataPoolSelectorWidget::HideToolTip);
   ...
   connect(this->mpc_Ui->pc_ListWidget, &C_SdNdeDataPoolSelectorListWidget::SigDataPoolChanged,
           this, &C_SdNdeDataPoolSelectorWidget::m_DpChangedUpdateUsageView);
   connect(this->mpc_Ui->pc_ListWidget, &C_SdNdeDataPoolSelectorListWidget::SigUpdateLists, this,
           &C_SdNdeDataPoolSelectorWidget::SigUpdateLists);
...
void C_SdNdeDataPoolSelectorWidget::SetActive(const bool oq_Active)
{
   ...
   if (this->mq_Active == true)
   {
      ...
      this->setStyleSheet("stw_opensyde_gui--C_SdNdeDataPoolSelectorWidget#" + this->mc_InstanceName + " {"
...
void C_SdNdeDataPoolSelectorWidget::CheckDataPoolInteraction(void)
{
   ...
   else
   {
      ...
      {
         this->mq_AllowInteraction = false;
      }
   }
   this->mpc_Ui->pc_PushButtonAdd->setEnabled(this->mq_AllowInteraction);
...
void C_SdNdeDataPoolSelectorWidget::m_SetupContextMenu(void)
{
   ...
   this->mpc_ContextMenu->addAction(C_GtGetText::h_GetText("Add new Datapool"), this,
                                    &C_SdNdeDataPoolSelectorWidget::m_AddNewDatapool,
   ...
   this->mpc_ContextMenu->addAction(C_GtGetText::h_GetText("Paste"), this,
                                    &C_SdNdeDataPoolSelectorWidget::m_PasteDatapool,
                                    static_cast<sintn>(Qt::CTRL) +
                                    static_cast<sintn>(Qt::Key_V));

   this->setContextMenuPolicy(Qt::CustomContextMenu);

   connect(this, &C_SdNdeDataPoolSelectorWidget::customContextMenuRequested, this,
