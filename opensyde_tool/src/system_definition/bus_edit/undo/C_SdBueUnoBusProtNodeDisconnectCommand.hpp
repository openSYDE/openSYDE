...
*/
//----------------------------------------------------------------------------------------------------------------------
#ifndef C_SDBUEUNOBUSPROTNODEDISCONNECTCOMMAND_HPP
#define C_SDBUEUNOBUSPROTNODEDISCONNECTCOMMAND_HPP
...
{
public:
   C_SdBueUnoBusProtNodeDisconnectCommand(const uint32_t ou32_NodeIndex, const uint32_t ou32_InterfaceIndex,
