   ...
   mq_Assigned(false)
{
   ...
   //Connects
   connect(this->mpc_Ui->pc_PushButtonClose, &stw::opensyde_gui_elements::C_OgePubTabClose::clicked, this,
...
*/
//----------------------------------------------------------------------------------------------------------------------
C_SyvDcExistingNodeDropAreaWidget::~C_SyvDcExistingNodeDropAreaWidget(void) noexcept
{
   delete mpc_Ui;
}
