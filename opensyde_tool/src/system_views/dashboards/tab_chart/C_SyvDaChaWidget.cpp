...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SyvDaChaWidget::ConnectionActiveChanged(const bool oq_Active, const QMap<uint32_t,
                                                                                bool> & orc_MappingNodeToTrafficEncryptionStatus)
{
   this->mq_IsConnected = oq_Active;
   this->mpc_Ui->pc_ChartWidget->ConnectionActiveChanged(oq_Active, orc_MappingNodeToTrafficEncryptionStatus);
