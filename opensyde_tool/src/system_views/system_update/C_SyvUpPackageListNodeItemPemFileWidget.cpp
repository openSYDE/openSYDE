...
#include "C_SyvUpPemFileInfoPopUp.h"
...
*/
//----------------------------------------------------------------------------------------------------------------------
C_SyvUpPackageListNodeItemPemFileWidget::C_SyvUpPackageListNodeItemPemFileWidget(const uint32 ou32_ViewIndex,
...
*/
//----------------------------------------------------------------------------------------------------------------------
uint32 C_SyvUpPackageListNodeItemPemFileWidget::GetType(void) const
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SyvUpPackageListNodeItemPemFileWidget::ViewFileInfo(void)
{
   if (this->GetAppFilePath().compare("") != 0)
   {
      QPointer<C_OgePopUpDialog> const c_New = new C_OgePopUpDialog(this, this);
      C_SyvUpPemFileInfoPopUp * const pc_InfoDialog =
         new C_SyvUpPemFileInfoPopUp(*c_New,
...
*/
//----------------------------------------------------------------------------------------------------------------------
bool C_SyvUpPackageListNodeItemPemFileWidget::IsViewFileInfoPossible(void) const
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SyvUpPackageListNodeItemPemFileWidget::SetPemStates(const C_PuiSvNodeUpdate::E_StateSecurity oe_StateSecurity,
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SyvUpPackageListNodeItemPemFileWidget::GetPemStates(C_PuiSvNodeUpdate::E_StateSecurity & ore_StateSecurity,
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SyvUpPackageListNodeItemPemFileWidget::m_LoadFileInformation(bool & orq_FileExists, bool & orq_FlashwareWarning,
...
*/
//----------------------------------------------------------------------------------------------------------------------
QString C_SyvUpPackageListNodeItemPemFileWidget::m_CreateToolTipTitle(void) const
{
