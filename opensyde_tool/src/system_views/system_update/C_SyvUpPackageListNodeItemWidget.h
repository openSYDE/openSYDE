...
*/
//----------------------------------------------------------------------------------------------------------------------
#ifndef C_SYVUPPACKAGELISTNODEITEMWIDGET_H
#define C_SYVUPPACKAGELISTNODEITEMWIDGET_H
...
namespace Ui
{
class C_SyvUpPackageListNodeItemWidget;
}
...
public:
   explicit C_SyvUpPackageListNodeItemWidget(const stw_types::uint32 ou32_ViewIndex,
   ...
   virtual ~C_SyvUpPackageListNodeItemWidget();
   ...
   void LoadImportConfig(const stw_opensyde_gui_logic::C_SyvUpUpdatePackageConfigNodeApp & orc_AppConfig);
...
protected:
   ...
   Ui::C_SyvUpPackageListNodeItemWidget * mpc_Ui;
