...
#include "ui_C_SyvUpPemFileInfoPopUp.h"
...
*/
//----------------------------------------------------------------------------------------------------------------------
C_SyvUpPemFileInfoPopUp::C_SyvUpPemFileInfoPopUp(stw_opensyde_gui_elements::C_OgePopUpDialog & orc_Parent,
                                                 const QString & orc_Path) :
   QWidget(&orc_Parent),
   mpc_Ui(new Ui::C_SyvUpPemFileInfoPopUp),
   mrc_ParentDialog(orc_Parent)
{
   ...
   connect(this->mpc_Ui->pc_PushButtonOk, &QPushButton::clicked, this, &C_SyvUpPemFileInfoPopUp::m_OkClicked);
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
C_SyvUpPemFileInfoPopUp::~C_SyvUpPemFileInfoPopUp(void)
{
   delete this->mpc_Ui;
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SyvUpPemFileInfoPopUp::InitStaticNames(void) const
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SyvUpPemFileInfoPopUp::keyPressEvent(QKeyEvent * const opc_KeyEvent)
{
   bool q_CallOrg = true;
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SyvUpPemFileInfoPopUp::m_OkClicked(void)
{
   this->mrc_ParentDialog.accept();
}
