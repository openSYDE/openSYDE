...
*/
//----------------------------------------------------------------------------------------------------------------------
#ifndef C_SYVUPPARAMSETFILEINFO_H
#define C_SYVUPPARAMSETFILEINFO_H
...
class C_SyvUpParamSetFileInfo
{
public:
   C_SyvUpParamSetFileInfo(const QString & orc_Path, const QString & orc_StoragePath,
...
private:
   ...
   std::vector<C_SyvUpParamSetFileInfoComparisonDescription> mc_ComparisonResults;
   static const QString mhc_StartHeadingTD;
   static const QString mhc_ContinueHeadingTD;
   static const QString mhc_StartDataTD;
   static const QString mhc_ContinueDataTD;
