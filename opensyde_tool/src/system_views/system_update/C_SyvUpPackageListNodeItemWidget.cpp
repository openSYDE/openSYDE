...
*/
//----------------------------------------------------------------------------------------------------------------------
C_SyvUpPackageListNodeItemWidget::C_SyvUpPackageListNodeItemWidget(const uint32 ou32_ViewIndex,
   ...
   mpc_Ui(new Ui::C_SyvUpPackageListNodeItemWidget),
...
*/
//----------------------------------------------------------------------------------------------------------------------
C_SyvUpPackageListNodeItemWidget::~C_SyvUpPackageListNodeItemWidget()
{
   delete mpc_Ui;
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
QWidget * C_SyvUpPackageListNodeItemWidget::GetListParent(void)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SyvUpPackageListNodeItemWidget::SetSelected(const bool oq_Selected)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SyvUpPackageListNodeItemWidget::SetState(const uint32 ou32_State)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SyvUpPackageListNodeItemWidget::SetOwnerSectionName(const QString & orc_Name)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SyvUpPackageListNodeItemWidget::SetAppNumber(const stw_types::uint32 ou32_Number)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SyvUpPackageListNodeItemWidget::SetAppFile(const QString & orc_File, const bool oq_DefaultFile)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SyvUpPackageListNodeItemWidget::SetDefaultFile(const QString & orc_File)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SyvUpPackageListNodeItemWidget::SetConnected(const bool oq_Connected)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SyvUpPackageListNodeItemWidget::SetSkipOfUpdateFile(const bool oq_Skip)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
uint32 C_SyvUpPackageListNodeItemWidget::GetState(void) const
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
uint32 C_SyvUpPackageListNodeItemWidget::GetAppNumber(void) const
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
QString C_SyvUpPackageListNodeItemWidget::GetAppFileName(void) const
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
QString C_SyvUpPackageListNodeItemWidget::GetAppFilePath(void) const
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
QString C_SyvUpPackageListNodeItemWidget::GetDefaultFilePath(void) const
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
QString C_SyvUpPackageListNodeItemWidget::GetAppAbsoluteFilePath(void) const
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
QString C_SyvUpPackageListNodeItemWidget::GetAppDeviceType(void) const
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
bool C_SyvUpPackageListNodeItemWidget::GetSkipOfUpdateFile(void) const
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
bool C_SyvUpPackageListNodeItemWidget::IsAppInfoAmbiguous(void) const
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
bool C_SyvUpPackageListNodeItemWidget::IsDefaultPathActive(void) const
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SyvUpPackageListNodeItemWidget::PrepareExportConfig(C_SyvUpUpdatePackageConfigNodeApp & orc_AppConfig)
const
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SyvUpPackageListNodeItemWidget::LoadImportConfig(const C_SyvUpUpdatePackageConfigNodeApp & orc_AppConfig)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_SyvUpPackageListNodeItemWidget::CheckPath(void)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
bool C_SyvUpPackageListNodeItemWidget::IsFileIdentical(const QString & orc_AppName, const QString & orc_AppVersion,
...
void C_SyvUpPackageListNodeItemWidget::ViewFileInfo(void)
{
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SyvUpPackageListNodeItemWidget::resizeEvent(QResizeEvent * const opc_Event)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
bool C_SyvUpPackageListNodeItemWidget::event(QEvent * const opc_Event)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SyvUpPackageListNodeItemWidget::m_LoadFileInformation(bool & orq_FileExists, bool & orq_FlashwareWarning,
...
*/
//----------------------------------------------------------------------------------------------------------------------
QString C_SyvUpPackageListNodeItemWidget::m_CreateToolTipTitle(void) const
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
QString C_SyvUpPackageListNodeItemWidget::m_CreateToolTipContent(void) const
{
   QString c_Content = "";
...
//----------------------------------------------------------------------------------------------------------------------
void C_SyvUpPackageListNodeItemWidget::m_UpateFilePathLabel(void) const
{
...
//----------------------------------------------------------------------------------------------------------------------
void C_SyvUpPackageListNodeItemWidget::m_UpdateAbsolutePath(void)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SyvUpPackageListNodeItemWidget::m_UpdateToolTip(void)
{
...
//----------------------------------------------------------------------------------------------------------------------
void C_SyvUpPackageListNodeItemWidget::m_SetSelectColor(const bool oq_Active)
{
   if ((oq_Active == true) &&
