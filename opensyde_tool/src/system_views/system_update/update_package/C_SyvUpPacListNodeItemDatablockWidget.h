...
*/
//----------------------------------------------------------------------------------------------------------------------
#ifndef C_SYVUPPACLISTNODEITEMDATABLOCKWIDGET_H
#define C_SYVUPPACLISTNODEITEMDATABLOCKWIDGET_H
...
{
public:
   C_SyvUpPacListNodeItemDatablockWidget(const stw_types::uint32 ou32_ViewIndex, const stw_types::uint32 ou32_NodeIndex,
