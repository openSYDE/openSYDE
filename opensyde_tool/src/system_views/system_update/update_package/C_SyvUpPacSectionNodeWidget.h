...
public:
   ...
   virtual ~C_SyvUpPacSectionNodeWidget();
   ...
   virtual void PrepareExportConfig(stw_opensyde_gui_logic::C_SyvUpPacConfigNode & orc_NodeConfig) const = 0;
   virtual void LoadImportConfig(const stw_opensyde_gui_logic::C_SyvUpPacConfig & orc_Config) = 0;
...
private:
   ...
   static const stw_types::sintn mhsn_TITLE_OFFSET = 140;
};
}
