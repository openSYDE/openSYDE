...
#include "ui_C_SyvUpParamSetFileInfoPopUp.h"
...
*/
//----------------------------------------------------------------------------------------------------------------------
C_SyvUpParamSetFileInfoPopUp::C_SyvUpParamSetFileInfoPopUp(stw_opensyde_gui_elements::C_OgePopUpDialog & orc_Parent,
                                                           const QString & orc_Path, const uint32 ou32_NodeIndex) :
   QWidget(&orc_Parent),
   mpc_Ui(new Ui::C_SyvUpParamSetFileInfoPopUp),
   ...
   mc_FileInfo(orc_Path, orc_Path, ou32_NodeIndex)
{
   ...
   connect(this->mpc_Ui->pc_PushButtonOk, &QPushButton::clicked, this, &C_SyvUpParamSetFileInfoPopUp::m_OkClicked);
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
C_SyvUpParamSetFileInfoPopUp::~C_SyvUpParamSetFileInfoPopUp(void)
{
   delete this->mpc_Ui;
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SyvUpParamSetFileInfoPopUp::InitStaticNames(void) const
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SyvUpParamSetFileInfoPopUp::keyPressEvent(QKeyEvent * const opc_KeyEvent)
{
   bool q_CallOrg = true;
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_SyvUpParamSetFileInfoPopUp::m_ReadFile(void)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SyvUpParamSetFileInfoPopUp::m_OkClicked(void)
{
   this->mrc_ParentDialog.accept();
}
