...
public:
   ...
   static bool h_CheckViewSetupError(const stw_types::uint32 ou32_ViewIndex, QString & orc_ErrorLabelText);
   ...
   static QString h_GetCommonDashboardItemToolTip(const stw_types::uint32 ou32_ViewIndex,
                                                  const stw_opensyde_gui_logic::C_PuiSvDbNodeDataPoolListElementId & orc_Id,
                                                  const bool oq_ReadItem = true,
                                                  const stw_opensyde_gui_logic::C_PuiSvDbWidgetBase::E_WriteMode oe_WriteMode = stw_opensyde_gui_logic::C_PuiSvDbWidgetBase::eWM_MANUAL);
