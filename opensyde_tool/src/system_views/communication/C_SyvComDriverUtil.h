...
public:
   static stw_types::sint32 h_GetOSCComDriverParamFromView(const stw_types::uint32 ou32_ViewIndex,
                                                           ...
                                                           stw_opensyde_core::C_OSCIpDispatcherWinSock ** const oppc_IpDispatcher, const bool oq_InitCan, const bool oq_IgnoreUpdateRoutingErrors, bool * const opq_DashboardRoutingErrors);
};
