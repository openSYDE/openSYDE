...
public:
   ...
   void InitSv(const uint32_t ou32_ViewIndex, const bool oq_ShowOnlyWriteElements, const bool oq_ShowArrayElements,
               ...
               const std::vector<stw::opensyde_gui_logic::C_PuiSvDbNodeDataPoolListElementId> * const opc_AlreasyUsedElements, const bool oq_UseInSysViews = true, const uint32_t ou32_SdDataLoggerUseCaseNodeIndex = 0UL, const bool oq_ShowStringElements = false);
