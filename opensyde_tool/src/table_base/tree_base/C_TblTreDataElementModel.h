...
private:
   ...
   static void mh_InitDatapoolElementsHALCConfig(C_TblTreItem * const opc_DpItem, bool & orq_HALCValid,
                                                 ...
                                                 const stw_opensyde_core::C_OSCHalcConfigDomain & orc_DomainConfig,
                                                 ...
                                                 const stw_types::uint32 ou32_DpIndex,
                                                 const stw_types::uint32 ou32_ChannelIndex,
                                                 const stw_types::uint32 ou32_ChannelArrayIndex,
                                                 stw_types::uint32 & oru32_CounterParam,
                                                 stw_types::uint32 & oru32_CounterInput,
                                                 stw_types::uint32 & oru32_CounterOutput,
                                                 stw_types::uint32 & oru32_CounterStatus,
                                                 const stw_types::uint32 ou32_RelevantChannelNumber,
                                                 const bool oq_ShowOnlyWriteElements, const bool oq_ShowArrayElements,
                                                 const bool oq_ShowArrayIndexElements, const bool oq_Show64BitValues,
                                                 const stw_opensyde_core::C_OSCHALCMagicianDatapoolListHandler & orc_DpHandler, const std::vector<C_PuiSvDbNodeDataPoolListElementId> * const opc_AlreasyUsedElements);
   static void mh_InitDatapoolElementsHALCConfigList(C_TblTreItem * const opc_ChannelItem, bool & orq_ChannelValid,
                                                     const std::vector<stw_opensyde_core::C_OSCHalcDefStruct> & orc_Values, const stw_opensyde_core::C_OSCNodeDataPoolList & orc_List, const stw_types::uint32 ou32_ChannelArrayIndex, const stw_types::uint32 ou32_NodeIndex, const stw_types::uint32 ou32_DpIndex, const stw_types::uint32 ou32_ListIndex, const stw_types::uint32 ou32_UseCase, stw_types::uint32 & oru32_Counter, const stw_types::uint32 ou32_RelevantChannelNumber, const bool oq_ChanNumVarNecessary, const bool oq_UseCaseVarNecessary, const bool oq_SafetyFlagVarNecessary, const bool oq_IsParam, const stw_scl::C_SCLString & orc_DomainSingularName, const bool oq_ShowOnlyWriteElements, const bool oq_ShowArrayElements, const bool oq_ShowArrayIndexElements, const bool oq_Show64BitValues, const std::vector<C_PuiSvDbNodeDataPoolListElementId> * const opc_AlreasyUsedElements, const QString & orc_HalChannelOrDomainName);
