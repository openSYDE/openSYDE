...
/*!
   \file
   \brief       Check box with tool tip (implementation)

   Check box with tool tip
...
*/
//----------------------------------------------------------------------------------------------------------------------
bool C_OgeChxToolTipBase::event(QEvent * const opc_Event)
{
   bool q_Return;
   ...
   if (this->mq_ToolTipActive == true)
   {
      ...
      {
         q_Return = QCheckBox::event(opc_Event);
      }
   }
   else
   {
