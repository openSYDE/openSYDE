...
/*!
   \file
   \brief       Text edit field with tool tip (implementation)

   Text edit field with tool tip
...
*/
//----------------------------------------------------------------------------------------------------------------------
bool C_OgeTedToolTipBase::event(QEvent * const opc_Event)
{
   bool q_Return;
   ...
   if (this->mq_ToolTipActive == true)
   {
      ...
      {
         q_Return = QTextEdit::event(opc_Event);
      }
   }
   else
   {
