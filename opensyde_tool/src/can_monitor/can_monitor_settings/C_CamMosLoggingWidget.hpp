...
*/
//----------------------------------------------------------------------------------------------------------------------
#ifndef C_CAMMOSLOGGINGWIDGET_HPP
#define C_CAMMOSLOGGINGWIDGET_HPP
...
public:
   ...
   void OnSigLogFileAddResult(const int32_t os32_Result);
...
private:
   ...
   void m_OnOverwriteModeSelected(const int32_t os32_Index) const;
   void m_OnFormatSelected(const int32_t os32_Index) const;
