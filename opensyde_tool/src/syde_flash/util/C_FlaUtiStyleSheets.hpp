...
/*!
   \file
   \brief       Utility class for stylesheets of SYDEflash (header)
...
*/
//----------------------------------------------------------------------------------------------------------------------
#ifndef C_FLAUTISTYLESHEETS_HPP
#define C_FLAUTISTYLESHEETS_HPP
...
private:
   ...
   static const std::vector<QString> mhc_SCROLL_BAR_SETTINGS_DARK_BLUE;
   static const std::vector<C_PropertyValueColorConfig> mhc_SCROLL_BAR_PROPERTIES_SETTINGS_DARK_BLUE;
