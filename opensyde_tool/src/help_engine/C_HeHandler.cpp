...
{
   //Main Page
   this->mc_LookUpHelpPageName.insert("stw::opensyde_gui::C_NagProjectSettingsPopupDialog",
                                      "Global Project Settings");

   this->mc_LookUpHelpPageName.insert("stw::opensyde_gui::C_NagToolSettingsPopupDialog",
                                      "Tool Settings");
