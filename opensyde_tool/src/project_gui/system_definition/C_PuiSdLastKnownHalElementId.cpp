...
*/
//----------------------------------------------------------------------------------------------------------------------
C_PuiSdLastKnownHalElementId::C_PuiSdLastKnownHalElementId() :
   u32_Crc(0UL)
{
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
C_PuiSdLastKnownHalElementId::C_PuiSdLastKnownHalElementId(const uint32_t ou32_Crc, const QString & orc_HalDpName)
{
...
void C_PuiSdLastKnownHalElementId::CalcHash(uint32_t & oru32_HashValue) const
{
   ...
   stw::scl::C_SclChecksums::CalcCRC32(this->c_HalDpName.toStdString().c_str(),
                                       static_cast<uint32_t>(this->c_HalDpName.length()), oru32_HashValue);
}
