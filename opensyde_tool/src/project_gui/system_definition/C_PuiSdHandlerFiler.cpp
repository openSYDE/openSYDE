...
*/
//-----------------------------------------------------------------------------
void C_PuiSdHandlerFiler::h_SaveDataPools(const std::vector<C_PuiSdNodeDataPool> & orc_DataPools,
                                          C_OSCXMLParserBase & orc_XMLParser)
{
...
*/
//-----------------------------------------------------------------------------
void C_PuiSdHandlerFiler::h_SaveCanProtocols(const std::vector<C_PuiSdNodeCanProtocol> & orc_CanProtocols,
                                             C_OSCXMLParserBase & orc_XMLParser)
{
...
*/
//-----------------------------------------------------------------------------
void C_PuiSdHandlerFiler::h_SaveNodes(const std::vector<C_PuiSdNode> & orc_Nodes, C_OSCXMLParserBase & orc_XMLParser)
{
   if (orc_Nodes.size() > 0)
   {
      ...
      {
         C_PuiSdHandlerFiler::mh_SaveNode(orc_Nodes[u32_Index], orc_XMLParser);
...
/*!
   ...
   \created     13.09.2016  STW/A.Stangl
*/
//-----------------------------------------------------------------------------
void C_PuiSdHandlerFiler::mh_SaveNode(const C_PuiSdNode & orc_Node, C_OSCXMLParserBase & orc_XMLParser)
{
   //GUI information is stored in "gui" subnode
...
/*!
   ...
   \created     09.09.2016  STW/A.Stangl
*/
//-----------------------------------------------------------------------------
