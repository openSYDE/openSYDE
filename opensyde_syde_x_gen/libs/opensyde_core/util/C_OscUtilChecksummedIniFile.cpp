...
*/
//----------------------------------------------------------------------------------------------------------------------
C_OscUtilChecksummedIniFile::~C_OscUtilChecksummedIniFile(void)
{
}

//----------------------------------------------------------------------------------------------------------------------

uint16_t C_OscUtilChecksummedIniFile::m_CalcCheckSum(const bool oq_Fast)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
bool C_OscUtilChecksummedIniFile::CheckCheckSum(void)
{
   uint16_t u16_CheckSumCalc;
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_OscUtilChecksummedIniFile::UpdateCheckSum(void)
{
