...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscSecurityAesFile::h_EncryptFile(const C_SclString & orc_Key, const C_SclString & orc_InFilePath,
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscSecurityAesFile::h_DecryptFile(const C_SclString & orc_Key, const C_SclString & orc_InFilePath,
                                            const C_SclString & orc_OutFilePath)
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscSecurityAesFile::h_CreateEncryptedZipFile(const C_SclString & orc_FolderPathToZip,
                                                       const std::set<C_SclString> & orc_SupFiles,
                                                       const C_SclString & orc_PathForZipFile,
                                                       const C_SclString & orc_Key,
                                                       C_SclString * const opc_ErrorMessage)
{
   ...
   if (s32_Return == C_NO_ERR)
   {
      if (orc_Key != "")
      {
         s32_Return = C_OscSecurityAesFile::h_EncryptFile(orc_Key, c_ZipFileTmp, orc_PathForZipFile);
      }
      else
      {
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscSecurityAesFile::h_UnpackEncryptedZipFile(const C_SclString & orc_PathOfZipFile,
                                                       const C_SclString & orc_FolderPathToUnzip,
                                                       const C_SclString & orc_Key,
                                                       C_SclString * const opc_ErrorMessage)
{
   int32_t s32_Return;
   ...
   if (orc_Key != "")
   {
      s32_Return = C_OscSecurityAesFile::h_DecryptFile(orc_Key, orc_PathOfZipFile, c_ZipFileTmp);
   }
   else
   {
