...
private:
   ...
   static stw_types::sint32 mh_CreateHALConfigCode(const C_OSCNode & orc_Node,
                                                   ...
                                                   std::vector<stw_scl::C_SCLString> & orc_Files,
                                                   const stw_scl::C_SCLString & orc_ExportToolInfo = "");
   static stw_types::sint32 mh_CreateHALNVMData(const C_OSCNode & orc_Node,
                                                const stw_types::uint16 ou16_ApplicationIndex,
                                                const stw_scl::C_SCLString & orc_Path,
                                                std::vector<stw_scl::C_SCLString> & orc_Files,
                                                const stw_scl::C_SCLString & orc_ExportToolName,
   ...
   static stw_types::sint32 mh_GetHALDataPoolIndices(const stw_opensyde_core::C_OSCNode & orc_Node, std::
                                                     map<bool, stw_types::sint32> & orc_HalcDataPools);
};
