...
public:
   ...
   bool GetNodeIndex(const C_OSCProtocolDriverOsyNode & orc_ServerId, stw_types::uint32 & oru32_NodeIndex) const;
   void ClearDispatcherQueue(void);
   bool IsInitialized(void) const;

   stw_types::sint32 ReConnectNode(const C_OSCProtocolDriverOsyNode & orc_ServerId) const;
   stw_types::sint32 DisconnectNode(const C_OSCProtocolDriverOsyNode & orc_ServerId) const;
   void DisconnectNodes(void) const;

   virtual void PrepareForDestruction(void);

   C_OSCProtocolDriverOsyTpBase * GetOsyTransportProtocol(const stw_types::uint32 ou32_NodeIndex);
...
protected:
   ...
   stw_types::uint32 m_GetActiveIndex(const C_OSCProtocolDriverOsyNode & orc_ServerId, bool & orq_Found) const;
   ...
   stw_types::sint32 m_SetNodeSessionId(C_OSCProtocolDriverOsy * const opc_ExistingProtocol,
   ...
   stw_types::sint32 m_SetNodeSecurityAccess(const stw_types::uint32 ou32_ActiveNode,
                                             ...
                                             stw_types::uint8 * const opu8_NrCode) const;
   stw_types::sint32 m_SetNodeSecurityAccess(C_OSCProtocolDriverOsy * const opc_ExistingProtocol,
                                             const stw_types::uint8 ou8_SecurityLevel,
                                             stw_types::uint8 * const opu8_NrCode) const;
