...
static const int16_t KNOWN_DEVICE_UNKNOWN = -1;
static const int16_t KNOWN_DEVICE_ESX     =  0; //Y ESX2
static const int16_t KNOWN_DEVICE_ESXLT   =  1; //Y ESX-Lt.
static const int16_t KNOWN_DEVICE_EHC     =  2; //CN EHC
static const int16_t KNOWN_DEVICE_MAX     =  3;

static const char_t maacn_KNOWN_DEVICE_NAMES[KNOWN_DEVICE_MAX][10] =
{
   "ESX2", //DEVICE_ESX
   "ESL",  //DEVICE_ESXLT
   "EHC"   //DEVICE_EHC
...
static uint16_t mu16_WinflashInternalKey = 0x0000U;

/* -- Module Global Function Prototypes ----------------------------------------------------------------------------- */

/* -- Implementation ------------------------------------------------------------------------------------------------ */

void XFLSetInternalKey(const uint16_t ou16_Key)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
C_XFLDivertParametersCAN::C_XFLDivertParametersCAN(const uint8_t ou8_NumPositions) :
...
{
   c_Parameters[mu8_PARAM_INDEX_CLIENT_ID_TYPE].u16_ParameterValue =  static_cast<uint16_t>(oq_StdIDs ? 1U : 0U);
   c_Parameters[mu8_PARAM_INDEX_CLIENT_ID_TYPE].u16_ParameterValue += static_cast<uint16_t>(oq_ExtIDs ? 2U : 0U);
}

//----------------------------------------------------------------------------------------------------------------------

void C_XFLDivertParametersCAN::SetValueClientBitrate(const uint16_t ou16_Bitrate_kBitS)
{
...
void C_XFLDivertParametersCAN::SetValueClientMaskStandard(const uint16_t ou16_Mask)
{
...
void C_XFLDivertParametersCAN::SetValueClientMaskExtended(const uint32_t ou32_Mask)
{
   c_Parameters[mu8_PARAM_INDEX_CLIENT_LW_MASK_EXT].u16_ParameterValue = static_cast<uint16_t>(ou32_Mask);
   c_Parameters[mu8_PARAM_INDEX_CLIENT_HW_MASK_EXT].u16_ParameterValue = static_cast<uint16_t>(ou32_Mask >> 16U);
}

//----------------------------------------------------------------------------------------------------------------------

void C_XFLDivertParametersCAN::SetValueClientIDStandard(const uint16_t ou16_ID)
{
...
void C_XFLDivertParametersCAN::SetValueClientIDExtended(const uint32_t ou32_ID)
{
   c_Parameters[mu8_PARAM_INDEX_CLIENT_LW_ID_EXT].u16_ParameterValue = static_cast<uint16_t>(ou32_ID);
   c_Parameters[mu8_PARAM_INDEX_CLIENT_HW_ID_EXT].u16_ParameterValue = static_cast<uint16_t>(ou32_ID >> 16U);
}
...
void C_XFLDivertParametersCAN::SetValueTargetBitrate(const uint16_t ou16_Bitrate_kBitS)
{
...
void C_XFLDivertParametersCAN::SetValueTargetMaskStandard(const uint16_t ou16_Mask)
{
...
void C_XFLDivertParametersCAN::SetValueTargetMaskExtended(const uint32_t ou32_Mask)
{
   c_Parameters[mu8_PARAM_INDEX_TARGET_LW_MASK_EXT].u16_ParameterValue = static_cast<uint16_t>(ou32_Mask);
   c_Parameters[mu8_PARAM_INDEX_TARGET_HW_MASK_EXT].u16_ParameterValue = static_cast<uint16_t>(ou32_Mask >> 16U);
}

//----------------------------------------------------------------------------------------------------------------------

void C_XFLDivertParametersCAN::SetValueTargetIDStandard(const uint16_t ou16_ID)
{
...
void C_XFLDivertParametersCAN::SetValueTargetIDExtended(const uint32_t ou32_ID)
{
   c_Parameters[mu8_PARAM_INDEX_TARGET_LW_ID_EXT].u16_ParameterValue = static_cast<uint16_t>(ou32_ID);
   c_Parameters[mu8_PARAM_INDEX_TARGET_HW_ID_EXT].u16_ParameterValue = static_cast<uint16_t>(ou32_ID >> 16U);
}
...
int32_t C_XFLActions::RequestNodeReset(const T_STWCAN_Msg_TX * const opt_ResetMessage, const bool oq_SingleNode)
{
...
int32_t C_XFLActions::m_WakeupLocalID(const C_XFLCompanyID & orc_CompanyID, const bool oq_MultiResponsesOK)
{
   int32_t s32_Return;
   uint8_t u8_NumFound;
...
int32_t C_XFLActions::m_WakeupSNR(const C_XFLCompanyID & orc_CompanyID, const uint8_t (&orau8_SNR)[6],
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_XFLActions::m_WakeupLocalIDAndSNR(const C_XFLCompanyID & orc_CompanyID, const uint8_t (&orau8_SNR)[6])
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_XFLActions::DivertStreamOnOff(const bool oq_On, const C_XFLDivertParameters & orc_DivertParams,
                                        const bool oq_UseHopHandle, const uint8_t ou8_HopHandle)
{
   int32_t s32_Return;
   uint8_t au8_Params[2];
   ...
   else
   {
      ...
      for (int32_t s32_Parameter = 0; s32_Parameter < orc_DivertParams.c_Parameters.GetLength(); s32_Parameter++)
      {
         ...
         au8_Params[1] = static_cast<uint8_t>(orc_DivertParams.c_Parameters[s32_Parameter].u16_ParameterValue >> 8U);
...
int32_t C_XFLActions::DivertStreamOnOffBBB(const bool oq_OnOff, const uint8_t ou8_TargetPosition,
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_XFLActions::ReadFlashInformation(C_XFLFlashInformation & orc_Information, C_SclString & orc_ErrorText)
{
   int32_t s32_Return;
   uint8_t u8_Index;
   uint8_t u8_RegionIndex;
   uint8_t u8_NumICs;
   uint8_t u8_NumRegions;
...
*/
//----------------------------------------------------------------------------------------------------------------------
uint16_t C_XFLFlashICInformation::GetNumberOfSectors(void) const
{
...
void C_XFLFlashInformation::ConvertToFlashSectorTable(C_XFLFlashSectors & orc_Sectors) const
{
   int32_t s32_ICIndex;
   int32_t s32_RangeIndex;
   uint32_t u32_SectorIndex;
   uint32_t u32_TotalIndex;
   uint32_t u32_CurrentOffset;
   int32_t s32_ProtectedIndex;
         ...
         for (u32_SectorIndex = 0U; u32_SectorIndex < static_cast<uint32_t>(u16_NumBlocks); u32_SectorIndex++)
         {
                 ...
                 s32_ProtectedIndex++)
            {
               if ((this->c_ProtectedSectors[s32_ProtectedIndex].u16_SectorNumber ==
                    static_cast<uint16_t>(u32_TotalIndex)) &&
                   (this->c_ProtectedSectors[s32_ProtectedIndex].u8_ICIndex == static_cast<uint8_t>(s32_ICIndex)))
               {
...
*/
//----------------------------------------------------------------------------------------------------------------------
bool C_XFLFlashSector::IsAddressWithinSector(const uint32_t ou32_Address) const
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_XFLFlashSectors::GetSectorOccupiedByAddress(const uint32_t ou32_Address, uint16_t & oru16_Sector) const
{
   ...
   for (s32_Index = 0; s32_Index < this->GetLength(); s32_Index++)
   {
      ...
      {
         oru16_Sector = static_cast<uint16_t>(s32_Index);
         s32_Return = C_NO_ERR;
         break;
      }
   }
...
*/
//----------------------------------------------------------------------------------------------------------------------
uint32_t C_XFLFlashInformation::GetEraseTimeByLinearSectorNumber(const uint16_t ou16_Sector) const
{
   uint16_t u16_NumSectors = 0U;
...
*/
//----------------------------------------------------------------------------------------------------------------------
uint32_t C_XFLFlashInformation::GetWriteTimeOfSlowestIC(void) const
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_XFLActions::CompIDStringToStruct(const C_SclString & orc_String, C_XFLCompanyID & orc_Data)
{
   //just to make sure we don't get any crap:
   (void)memset(&orc_Data.au8_Data[0], 0, sizeof(orc_Data.au8_Data));
   return CID_string_to_bytes(orc_String.c_str(), &orc_Data.au8_Data[0], &orc_Data.u8_NumBytes);
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_XFLActions::CompIDStructToString(const C_XFLCompanyID & orc_Data, C_SclString & orc_String)
{
   int32_t s32_Return;
   char_t acn_Help[6];

   s32_Return = CID_bytes_to_string(&orc_Data.au8_Data[0], orc_Data.u8_NumBytes, &acn_Help[0]);
   if (s32_Return == C_NO_ERR)
   {
      orc_String = acn_Help;
   }
...
*/
//----------------------------------------------------------------------------------------------------------------------
C_SclString C_XFLActions::XFLProtocolErrorToText(const int32_t os32_ReturnValue, const uint8_t ou8_ErrorCode)
{
   C_SclString c_Help;
...
C_SclString C_XFLActions::SNRBytesToString(const uint8_t (&orau8_Data)[6], const bool oq_IncludeDots)
{
   C_SclString c_Text;
...
int32_t C_XFLActions::SNRStringToBytes(const C_SclString & orc_Text, uint8_t (&orau8_Data)[6])
{
   uint8_t u8_Index;
   C_SclString c_SNR;
   C_SclString c_Help;
   ...
   try
   {
      ...
      {
         c_Help = static_cast<C_SclString>("0x") + c_SNR[(static_cast<int32_t>(u8_Index) * 2U) + 1U];
         orau8_Data[u8_Index] = static_cast<uint8_t>(static_cast<uint8_t>(c_Help.ToInt()) << 4U);
         c_Help = static_cast<C_SclString>("0x") + c_SNR[(static_cast<int32_t>(u8_Index) * 2U) + 2U];
         orau8_Data[u8_Index] += static_cast<uint8_t>(c_Help.ToInt());
      }
   }
   catch (...)
   {
                                  ...
                                  const uint8_t ou8_FlashInterval, C_SclDynamicArray<C_XFLFoundNode> & orc_FoundNodes)
{
   ...
   int32_t s32_Return;
   uint8_t au8_Found[XFL_NUM_DIFFERENT_LOCAL_IDS];
   C_XFLCompanyID c_CompIDIn;
   uint8_t u8_NumFound;
   uint8_t u8_NumSNRsFound;
   ...
   if (u8_NumFound > 0U)
   {
      ...
      s32_IndexInTable = 0;
      for (int32_t s32_IdIndex = 0; s32_IdIndex < XFL_NUM_DIFFERENT_LOCAL_IDS; s32_IdIndex++)
      {
         if ((static_cast<uint16_t>(au8_Found[s32_IdIndex])) > u8_MAX_NUM_ECUS_PER_LOCAL_ID)
         {
            return C_OVERFLOW;
         }
         ...
         if (au8_Found[s32_IdIndex] > 0U)
         {
            ...
            {
               orc_FoundNodes[s32_j].u8_NodeId = static_cast<uint8_t>(s32_IdIndex);
            }

            //read out SNR(s)
            CfgSetLocalId(static_cast<uint8_t>(s32_IdIndex));
            ...
            else
            {
               ...
               else
               {
                  ...
                  if (u8_NumSNRsFound > au8_Found[s32_IdIndex])
                  {
                     ...
                     c_Node.u8_NodeId = static_cast<uint8_t>(s32_IdIndex);
                     c_Node.c_SNR = "?\?\?";
                     c_Node.c_DeviceId = "?\?\?";
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_XFLActions::ReadServerInformation(C_XFLInformationFromServer & orc_Info)
{
   int32_t s32_Return;
   int32_t s32_Loop;
   uint8_t u8_Size;
   ...
   uint8_t au8_SNR[6];
   uint32_t u32_FlashloaderVersion;
   uint16_t u16_Ident;
   int16_t s16_Device = KNOWN_DEVICE_UNKNOWN;
   ...
   if (s32_Return == C_NO_ERR)
   {
      ...
      for (s32_Loop = 0; s32_Loop < KNOWN_DEVICE_MAX; s32_Loop++)
      {
         ...
         {
            s16_Device = static_cast<int16_t>(s32_Loop);
         }
      }
   }
   else
   ...
   if (s32_Return == C_NO_ERR)
   {
      ...
      case 1U: //"old" implementation
         //BCD coded
         orc_Info.c_FlashloaderVersion = C_SclString::IntToStr(static_cast<uint8_t>(au8_Version[0] >> 4U)) + "." +
                                         C_SclString::IntToStr(au8_Version[0] & 0x0FU);

         orc_Info.q_FlashloaderVersionValid = true;
         break;
      case 5U:
         u16_Ident = static_cast<uint16_t>(((static_cast<uint16_t>(au8_Version[3])) << 8U) + au8_Version[4]);
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_XFLActions::ReadServerBlockChecksumInformation(C_XFLChecksumAreas & orc_ChecksumInformation)
{
   int32_t s32_Return;
   bool q_CheckStartup;
        ...
        s32_Block++)
   {
      ...
      if ((orc_ChecksumInformation.c_BlockConfig[s32_Block].q_BlockDefinitionValid == true) &&
          (orc_ChecksumInformation.c_BlockConfig[s32_Block].u32_EndAddress != XFL_CHK_BLOCK_END_INVALID))
      {
         ...
         s32_Return = GetBlockChecksum(static_cast<uint8_t>(s32_Block), 1U, u32_CheckSumCalc);
         if (s32_Return != C_NO_ERR)
         {
         ...
         s32_Return = GetBlockCompareMode(static_cast<uint8_t>(s32_Block), q_CheckStartup, q_CheckAfterFlashing);
         if (s32_Return != C_NO_ERR)
         {
      ...
      orc_ChecksumInformation.c_Areas[s32_Block].q_CheckAtStartup     = q_CheckStartup;
      orc_ChecksumInformation.c_Areas[s32_Block].q_CheckAfterFlashing = q_CheckAfterFlashing;
      orc_ChecksumInformation.c_Areas[s32_Block].u32_ChecksumEEP  = u32_CheckSumEEPROM;
      orc_ChecksumInformation.c_Areas[s32_Block].u32_ChecksumCalc = u32_CheckSumCalc;
   }
   return C_NO_ERR;
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_XFLActions::ReadServerSectorChecksumInformation(const uint16_t ou16_SectorCount,
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_XFLActions::PerformWakeup(const C_XFLWakeupParameters & orc_Parameters, uint8_t * const opu8_ActualLocalID)
{
   int32_t s32_Return;
   uint8_t u8_ActualLocalID;
