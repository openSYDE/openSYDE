...
static const uint16 mu16_TIMEOUT_READ_INFO_MS      =   300U;
static const uint16 mu16_TIMEOUT_WRITE_CONFIG_MS   =  1100U;
static const uint16 mu16_TIMEOUT_CALC_CHECKSUM_MS  =  2100U;
...
static const uint8 mu8_XFL_CMD_GET_FLASH_INFORMATION_IDX_IC_COUNT          = 0x01U;
static const uint8 mu8_XFL_CMD_GET_FLASH_INFORMATION_IDX_TOTAL_SIZE        = 0x02U;
static const uint8 mu8_XFL_CMD_GET_FLASH_INFORMATION_IDX_PROTECTED_SECTORS = 0x03U;
static const uint8 mu8_XFL_CMD_GET_FLASH_INFORMATION_IDX_OFFSET_ADDRESS    = 0x04U;
static const uint8 mu8_XFL_CMD_GET_FLASH_INFORMATION_IDX_NUM_REGIONS       = 0x05U;
static const uint8 mu8_XFL_CMD_GET_FLASH_INFORMATION_IDX_REGION_INFO       = 0x06U;
static const uint8 mu8_XFL_CMD_GET_FLASH_INFORMATION_IDX_ERASE_TIME        = 0x07U;
static const uint8 mu8_XFL_CMD_GET_FLASH_INFORMATION_IDX_PROGRAM_TIME      = 0x08U;
...
static const uint8 mu8_XFL_CMD_GET_IMPLEMENTATION_INFORMATION_PROTOCOL_VERSION = 0x01U;
static const uint8 mu8_XFL_CMD_GET_IMPLEMENTATION_INFORMATION_SPECIAL_SERVICES = 0x02U;
static const uint8 mu8_XFL_CMD_GET_IMPLEMENTATION_INFORMATION_GET_SERVICES     = 0x03U;
static const uint8 mu8_XFL_CMD_GET_IMPLEMENTATION_INFORMATION_SET_SERVICES     = 0x04U;
static const uint8 mu8_XFL_CMD_GET_IMPLEMENTATION_INFORMATION_FLASH_SERVICES   = 0x05U;
static const uint8 mu8_XFL_CMD_GET_IMPLEMENTATION_INFORMATION_TARGET_SPECIFIC_SERVICES = 0x06U;
static const uint8 mu8_XFL_CMD_GET_IMPLEMENTATION_INFORMATION_HEX_RECORDS      = 0x07U;

//get_set_finger_print
static const uint8 mu8_XFL_CMD_FINGER_PRINT_SUPPORTED_INDEXES = 0x00U;
static const uint8 mu8_XFL_CMD_FINGER_PRINT_PROGRAMMING_TIME  = 0x01U;
static const uint8 mu8_XFL_CMD_FINGER_PRINT_PROGRAMMING_DATE  = 0x02U;
static const uint8 mu8_XFL_CMD_FINGER_PRINT_CHECKSUM          = 0x03U;
static const uint8 mu8_XFL_CMD_FINGER_PRINT_USERNAME_1        = 0x04U;
static const uint8 mu8_XFL_CMD_FINGER_PRINT_USERNAME_2        = 0x05U;
static const uint8 mu8_XFL_CMD_FINGER_PRINT_USERNAME_3        = 0x06U;
static const uint8 mu8_XFL_CMD_FINGER_PRINT_USERNAME_4        = 0x07U;

//get_device_info_address
static const uint8 mu8_XFL_CMD_GET_DEVICE_INFO_ADDRESS_NUM_BLOCKS = 0xFFU;
...
sint32 C_XFLProtocol::m_SendFlashMessage(void)
{
   ...
   mc_CanWriteMessage.au8_Data[0] = static_cast<uint8>('F');
   mc_CanWriteMessage.au8_Data[1] = static_cast<uint8>('L');
   mc_CanWriteMessage.au8_Data[2] = static_cast<uint8>('A');
   mc_CanWriteMessage.au8_Data[3] = static_cast<uint8>('S');
   mc_CanWriteMessage.au8_Data[4] = static_cast<uint8>('H');
   return m_CANSendMessage();
}
...
/*!
   ...
   \created     xx.xx.199x  STW/O.Kemmer
*/
//-----------------------------------------------------------------------------
sint32 C_XFLProtocol::SendFLASH(const uint32 ou32_StartTimeMs, const uint8 ou8_FLASHIntervalMs)
{
   ...
   do
   {
      ...
      if (ou32_StartTimeMs != 0U)
      {
         ...
         s32_Return = TRG_ReportProgress(static_cast<uint16>(u32_Progress), TGL_LoadStr(STR_FDL_TXT_WR_FLASH_RQ));
...
/*!
   ...
   \created     29.07.2009  STW/A.Stangl
*/
//-----------------------------------------------------------------------------
   ...
   do
   {
      ...
      if (m_CANGetResponse(t_RXMsg) == C_NO_ERR)
      {
         if (t_RXMsg.au8_Data[0] == ou8_ExpectedLocalID)
         {
            ...
            {
               if ((os16_CheckDLC == -1) || (t_RXMsg.u8_DLC == static_cast<uint8>(os16_CheckDLC)))
               {
                  if (opc_MSG != NULL)
                  {
                     (*opc_MSG) = t_RXMsg;
...
/*!
   ...
   \created     25.10.2010  STW/A.Stangl
*/
//-----------------------------------------------------------------------------
                                    ...
                                    const uint32 ou32_InterFrameDelayUs, const uint32 ou32_TimeOut)
{
   ...
   do
   {
      ...
      {
         u8_SendNow = static_cast<uint8>((s32_RemainingLength > 7) ? 7 : s32_RemainingLength);
         (void)memcpy(&mc_CanWriteMessage.au8_Data[1], &opu8_HexLine[s32_Counter - 1], u8_SendNow);
         s32_Counter += u8_SendNow;
         mc_CanWriteMessage.u8_DLC = static_cast<uint8>(1U + u8_SendNow);
                                       ...
                                       const uint32 ou32_TimeOut)
{
   ...
   do
   {
      ...
      u16_LineLength = static_cast<uint16>((static_cast<uint16>(pu8_NextLine[0])) + 5U);
...
//------------------------------------------------------------------------
//   21.03.2011        STW/A.Stangl  added support for > 255 sectors
...
//  22.01.03    ASW         created
//************************************************************************
sint32 C_XFLProtocol::GetLocalIDExt(uint8 * const opu8_LocalId, const uint8 ou8_NumMaxLocalId,
                                    uint8 & oru8_NumFoundECUs)
{
   uint32 u32_StartTime;
   T_STWCAN_Msg_RX t_RXMsg;
   uint8 u8_Found = 0U;
...
//  22.01.03    ASW         created
//************************************************************************
sint32 C_XFLProtocol::NodeSleep(const uint8 ou8_LocalID)
{
   mc_CanWriteMessage.u8_DLC = 3U;
   mc_CanWriteMessage.u32_ID = mc_Config.u32_SendID;
...
// .HISTORY
//  Date        Author      Commentary
//  23.03.99    AST         created
//************************************************************************
sint32 C_XFLProtocol::SetLocalID(const uint8 ou8_LocalIDNew)
{
   uint32 u32_StartTime;
   T_STWCAN_Msg_RX t_RXMsg;
...
/*!
   ...
   \created     23.03.1999  STW/A.Stangl
*/
//-----------------------------------------------------------------------------
...
/*!
   ...
   \created     16.08.2002  STW/A.Stangl
*/
//-----------------------------------------------------------------------------
sint32 C_XFLProtocol::SetCANType(const bool oq_XtdOn)
{
   ...
   mc_CanWriteMessage.au8_Data[3] = static_cast<uint8>(oq_XtdOn);
   m_SendMessageWithIDs();
...
/*!
   ...
   \created     12.04.2000  STW/A.Stangl
*/
//-----------------------------------------------------------------------------
sint32 C_XFLProtocol::ReadFlash(const uint8 ou8_NumBytes, const uint32 ou32_StartAddress, uint8 * const opu8_Data)
{
   ...
   uint8 u8_ChecksumCalc;
   uint8 u8_ChecksumReceived = 0U;
   uint32 u32_StartTime;
   uint8 u8_Loop;
   sint32 s32_Return;
   uint8 u8_CopyNow;
   ...
   for (u8_Loop = 0U; u8_Loop < static_cast<uint8>((ou8_NumBytes / 7U) + 1U); u8_Loop++)
   {
      u32_StartTime = TGL_GetTickCount();
      s32_Return = C_COM;
      do
      {
         ...
         if (m_CANGetResponse(t_RXMsg) == C_NO_ERR)
         {
            if (t_RXMsg.au8_Data[0] == mc_Config.u8_LocalID)
            {
               ...
               u8_CopyNow = static_cast<uint8>(((ou8_NumBytes - u16_Counter) > 7) ? 7U : (ou8_NumBytes - u16_Counter));
               if (t_RXMsg.u8_DLC < static_cast<uint8>(1U + u8_CopyNow))
               {
                  s32_Return = C_NOACT;
               }
               else
               {
                  ...
                  u16_Counter = static_cast<uint16>(u16_Counter + 7U);
   ...
   if (static_cast<uint8>(u8_ChecksumReceived + u8_ChecksumCalc) != 0U)
   {
      return C_CHECKSUM;
   }
...
/*!
   ...
   \created     20.04.2000  STW/A.Stangl
*/
//-----------------------------------------------------------------------------
sint32 C_XFLProtocol::GetVersionNumber(uint8 (&orau8_Version)[5], uint8 & oru8_VersionSize)
{
   ...
   if (s32_Return == C_NO_ERR)
   {
      ...
      {
         oru8_VersionSize = static_cast<uint8>(t_RXMsg.u8_DLC - 3U);
...
// .HISTORY
//  Date        Author      Commentary
//  26.05.00    AST         created
//************************************************************************
sint32 C_XFLProtocol::SendSingleMessage(const T_STWCAN_Msg_TX & orc_Msg)
{
...
// .HISTORY
//  Date        Author      Commentary
//  15.06.00    AST         created
//************************************************************************
sint32 C_XFLProtocol::m_SendCompanyIDExt(const uint8 ou8_LocalID, const C_XFLCompanyID & orc_CompIDIn,
                                         uint8 & oru8_NumFound, C_XFLCompanyID * const opc_CompIDOut)
{
   uint32 u32_StartTime;
   ...
   mc_CanWriteMessage.u32_ID = mc_Config.u32_SendID;
   mc_CanWriteMessage.u8_DLC = static_cast<uint8>(3U + orc_CompIDIn.u8_NumBytes);
   mc_CanWriteMessage.au8_Data[0] = ou8_LocalID;
   mc_CanWriteMessage.au8_Data[1] = mu8_XFL_CMD_GRP_FLASH_COMMAND;
             ...
             ((t_RXMsg.u8_DLC == 5U) || (t_RXMsg.u8_DLC == 8U)))
         {
            ...
            if ((t_RXMsg.u8_DLC != mc_CanWriteMessage.u8_DLC) || (s32_Diff != 0))
            {
               if (s32_Return == C_NO_ERR) //only report the first differing response
               {
                  ...
                  {
                     opc_CompIDOut->u8_NumBytes = static_cast<uint8>(t_RXMsg.u8_DLC - 3U);
...
/*!
   ...
   \created     15.06.2000  STW/A.Stangl
*/
//-----------------------------------------------------------------------------
                                    ...
                                    C_XFLCompanyID * const opc_CompanyIDOut)
{
   ...
   sint32 s32_Return;
   T_STWCAN_Msg_RX t_RXMsg;
   uint8 u8_NumFoundWakeup = 0U;
   uint8 u8_NumFoundCompID = 0U;
   ...
   for(;;)
   {
      ...
      if ((TGL_GetTickCount() - u32_OldTime) > mu16_TIMEOUT_CHANGE_STATE_MS)
      {
         break;
      }
   }
...
//  15.06.00    AST         created
//************************************************************************
sint32 C_XFLProtocol::GetSNRExt(uint8 * const opu8_SNR, const uint8 ou8_NumMax, uint8 & oru8_NumFound)
{
   uint32 u32_StartTime;
   T_STWCAN_Msg_RX t_RXMsg;
   uint8 u8_Found = 0U;
...
// C_NOACT        -> error response
// C_NO_ERR       -> no errors
sint32 C_XFLProtocol::GetModeCompare(const uint16 ou16_Sector, uint8 & oru8_ModeCompare)
{
   sint32 s32_Return;
   T_STWCAN_Msg_RX t_RXMsg;
   ...
   s32_Return = m_WaitForResponse(mc_Config.u8_LocalID, mu16_TIMEOUT_READ_INFO_MS, mc_CanWriteMessage.au8_Data,
                                  static_cast<uint8>(mc_CanWriteMessage.u8_DLC - 1U), &t_RXMsg,
                                  static_cast<sint16>(mc_CanWriteMessage.u8_DLC) + 1U);
   if (s32_Return == C_NO_ERR)
   {
      if (ou16_Sector > 255U)
      {
...
// C_NOACT        -> error response
// C_NO_ERR       -> no errors
sint32 C_XFLProtocol::SetModeCompare(const uint16 ou16_Sector, const uint8 ou8_ModeCompare)
{
...
//  XFL_ERR_GENERAL_ERR -> error response
sint32 C_XFLProtocol::GetEraseCount(uint32 & oru32_EraseCount)
{
   sint32 s32_Return;
   T_STWCAN_Msg_RX t_RXMsg;
...
// .HISTORY
//  Date        Author      Commentary
//  28.11.05    AST         created
//************************************************************************
sint32 C_XFLProtocol::SetDivertParameter(const uint8 ou8_Device, const uint8 ou8_Position,
                                         const uint8 ou8_ParameterNumber, const uint8 (&orau8_Data)[2])
{
   mc_CanWriteMessage.u8_DLC = 8U;
   mc_CanWriteMessage.au8_Data[1] = mu8_XFL_CMD_GRP_SET_COMMAND;
...
// .HISTORY
//  Date        Author      Commentary
//  22.08.00    AST         created
//************************************************************************
sint32 C_XFLProtocol::SetTimeoutFactor(const uint8 ou8_Type, const uint8 ou8_Factor)
{
   if (ou8_Type > 1U)
   {
      return C_RANGE;
...
//  22.08.00    AST         created
//************************************************************************
sint32 C_XFLProtocol::GetTimeoutFactor(const uint8 ou8_Type, uint8 & oru8_Factor)
{
   sint32 s32_Return;
   T_STWCAN_Msg_RX t_RXMsg;
...
// bbWakeup =====================================================================
//  ESX2 specific function
sint32 C_XFLProtocol::BBWakeup(const uint8 ou8_Position, const uint8 (&orau8_LastUserSignature)[2])
{
   mc_CanWriteMessage.u8_DLC = 6U;
   mc_CanWriteMessage.au8_Data[1] = mu8_XFL_CMD_GRP_FLASH_COMMAND;
...
/*!
   ...
   \created     10.04.2012  STW/A.Stangl
*/
//-----------------------------------------------------------------------------
sint32 C_XFLProtocol::DivertStream(const uint8 ou8_Device, const uint8 ou8_Position, const uint8 ou8_State,
...
// .HISTORY
//  Date        Author      Commentary
//  06.10.00    AST         created
//************************************************************************
sint32 C_XFLProtocol::GetLastUser(uint8 (&orau8_LastUser)[2])
{
   sint32 s32_Return;
   T_STWCAN_Msg_RX t_RXMsg;
...
/*!
   ...
   \created     15.04.2008  STW/A.Stangl
*/
//-----------------------------------------------------------------------------
      ...
      if (m_CANGetResponse(t_RXMsg) == C_NO_ERR)
      {
         if (t_RXMsg.au8_Data[0] == mc_Config.u8_LocalID)
         {
            if ((t_RXMsg.au8_Data[1] == mu8_XFL_CMD_GRP_GET_COMMAND) &&
                ...
                (t_RXMsg.u8_DLC >= 4U))
            {
               (void)memcpy(&oracn_Data[0], &t_RXMsg.au8_Data[4], static_cast<uintn>(t_RXMsg.u8_DLC) - 4U);
...
/*!
   ...
   \created     09.11.2000  STW/A.Stangl
*/
//-----------------------------------------------------------------------------
         ...
         if (m_CANGetResponse(t_RXMsg) == C_NO_ERR)
         {
            if (t_RXMsg.au8_Data[0] == mc_Config.u8_LocalID)
            {
               if ((t_RXMsg.au8_Data[1] == mu8_XFL_CMD_GRP_GET_COMMAND) &&
                   ...
                   (t_RXMsg.u8_DLC > 3U))
               {
                  (void)memcpy(&acn_DeviceID[0], &t_RXMsg.au8_Data[3], static_cast<uintn>(t_RXMsg.u8_DLC) - 3U);
                  s32_Return = C_NO_ERR;
               }
               if (t_RXMsg.au8_Data[1] == mu8_COMMAND_ERR)
               {
...
sint32 C_XFLProtocol::m_CANSendMessage(const T_STWCAN_Msg_TX & orc_MSG)
{
...
sint32 C_XFLProtocol::m_SendMessageWithIDs(void)
{
   mc_CanWriteMessage.u32_ID      = mc_Config.u32_SendID;
...
sint32 C_XFLProtocol::m_CANSendMessage(void)
{
   tgl_assert(mc_Config.pc_CANDispatcher != NULL);
   if (mc_Config.pc_CANDispatcher == NULL)
   {
...
sint32 C_XFLProtocol::EEPROMRead(const uint8 ou8_NumBytes, const uint16 ou16_StartAddress, uint8 * const opu8_Data)
{
   uint32 u32_StartTime;
   sint32 s32_Return;
   uint8 i;
...
sint32 C_XFLProtocol::EEPROMWrite(const uint8 ou8_NumBytes, const uint16 ou16_StartAddress,
                                  const uint8 * const opu8_Data)
{
   ...
   bool q_OK;
   uint8 u8_NumMessages;
   uint8 u8_NumBytesNow;
   uint8 u8_BytesLeft;
   uint16 u16_Address;
   T_STWCAN_Msg_RX t_RXMsg;

   u8_NumMessages = static_cast<uint8>((ou8_NumBytes + 3U) / 4U);
   ...
   for (u8_Message = 0U; u8_Message < u8_NumMessages; u8_Message++)
   {
      ...
      u8_BytesLeft -= static_cast<uint8>(((u8_BytesLeft > 4U) ? 4U : u8_BytesLeft));
   }
   return C_NO_ERR;
}
...
/*!
   ...
   \created     14.04.2008  STW/A.Stangl
*/
//-----------------------------------------------------------------------------
                                          ...
                                          uint8 (&orau8_Result)[4])
{
   ...
   mc_CanWriteMessage.u8_DLC      = static_cast<uint8>(4U + ou8_NumParamsToUse);
   mc_CanWriteMessage.au8_Data[1] = mu8_XFL_CMD_GRP_GET_COMMAND;
...
/*!
   ...
   \created     30.07.2015  STW/A.Stangl
*/
//-----------------------------------------------------------------------------
...
/*!
   ...
   \created     24.04.2008  STW/A.Stangl
*/
//-----------------------------------------------------------------------------
sint32 C_XFLProtocol::GetDeviceInfoBlock(const uint32 ou32_Address, C_XFLECUInformation & orc_Data)
{
   ...
   uint8 u8_Size;
   bool q_IsV2 = false;
   uint8 u8_VersionIndex;

   orc_Data.ClearContents();

   //check that sizes match; otherwise the following charn / uint8 assignment will fail miserable
   tgl_assert(sizeof(charn) == sizeof(uint8)); //lint !e948  //evaluates to contant true if everything is fine ...
   ...
   u16_Offset = static_cast<uint16>(u16_Offset + 2U);
   ...
   if (orc_Data.ContainsDeviceID() == true)
   {
      ...
      s32_Return = this->ReadFlash(u8_Size, ou32_Address + u16_Offset,
                                   reinterpret_cast<uint8 *>(orc_Data.acn_DeviceID)); //lint !e926 //cf. assertion above
      if (s32_Return != C_NO_ERR)
      {
         return s32_Return;
      }
      u16_Offset = static_cast<uint16>(u16_Offset + u8_Size);
   }
   ...
   if (orc_Data.ContainsDateAndTime() == true)
   {
      ...
      s32_Return = this->ReadFlash(u8_Size, ou32_Address + u16_Offset,
                                   reinterpret_cast<uint8 *>(orc_Data.acn_Date)); //lint !e926 //cf. assertion above
      if (s32_Return != C_NO_ERR)
      {
         return s32_Return;
      }
      ...
      s32_Return = this->ReadFlash(u8_Size, ou32_Address + u16_Offset,
                                   reinterpret_cast<uint8 *>(orc_Data.acn_Time)); //lint !e926 //cf. assertion above
      if (s32_Return != C_NO_ERR)
      {
         return s32_Return;
      }
...
/*!
   ...
   \created     08.05.2008  STW/A.Stangl
*/
//-----------------------------------------------------------------------------
...
/*!
   ...
   \created     18.09.2008  STW/A.Stangl
*/
//-----------------------------------------------------------------------------
...
/*!
   ...
   \created     15.04.2009  STW/A.Stangl
*/
//-----------------------------------------------------------------------------
...
/*!
   ...
   \created     27.01.2012  STW/A.Stangl
*/
//-----------------------------------------------------------------------------
