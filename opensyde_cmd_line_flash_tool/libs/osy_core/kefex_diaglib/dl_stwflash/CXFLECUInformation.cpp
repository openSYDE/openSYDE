...
const uint8_t C_XFLECUInformation::hau8_LENGTHS_DATE[3]            =
{
   11U, 12U, 12U
};
const uint8_t C_XFLECUInformation::hau8_LENGTHS_TIME[3]            =
{
   8U,  9U,  9U
};
const uint8_t C_XFLECUInformation::hau8_LENGTHS_PROJECT_NAME[3]    =
{
   15U, 16U, 33U
};
const uint8_t C_XFLECUInformation::hau8_LENGTHS_PROJECT_VERSION[3] =
{
   10U, 11U, 17U
};
...
uint16_t C_XFLECUInformation::GetMaxSizeOnECU(void) const
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_XFLECUInformation::m_ParsePayload(const uint8_t * const opu8_Data, const uint16_t ou16_NumBytesAvailable,
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_XFLECUInformation::ParseFromBLOB(const uint8_t * const opu8_Data, const uint16_t ou16_NumBytesAvailable)
{
   ...
   if (s32_Return == C_NO_ERR)
   {
      ...
      else
      {
         ...
         u16_Length = (static_cast<uint16_t>(XFL_DEVICE_INFO_MAGIC_LENGTH_V1) + ((q_V2OrV3Detected == true) ? 1 : 0));
...
C_SclString C_XFLECUInformation::m_GetNonTerminatedString(const char_t * const opcn_Chars,
...
int32_t C_XFLECUInformation::GetInfoLevel(void) const
{
