...
static const uint16_t mau16_CRC_TABLE[] =
{
...
int32_t C_SclChecksums::CalcCRC32TriCore(const void * const opv_Start, const uint32_t ou32_NumBytes, uint32_t & oru32_CRC)
{
   ...
   {
      for (uint32_t u32_IndexWord = 0U; u32_IndexWord < (ou32_NumBytes / 4U); u32_IndexWord++)
      {
         uint32_t u32_Tmp1 = 0U;
         uint32_t u32_Tmp2;
         uint32_t u32_Value;
         ...
         u32_Value = static_cast<uint32_t>(pu8_Data[u32_IndexWord * 4]) +
