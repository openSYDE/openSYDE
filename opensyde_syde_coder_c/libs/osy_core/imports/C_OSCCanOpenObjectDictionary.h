...
public:
   ...
   bool IsMappableIntoTPDO(void) const;
   bool IsMappableIntoRPDO(void) const;
...
public:
   ...
   stw_types::sint32 IsHeartbeatConsumerRo(bool & orq_IsRo) const;
   bool IsHeartbeatProducerSupported(void) const;
   stw_types::sint32 IsHeartbeatProducerRo(bool & orq_IsRo) const;
