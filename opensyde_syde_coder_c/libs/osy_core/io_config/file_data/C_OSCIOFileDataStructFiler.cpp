...
/*!
   ...
   Load IO description struct section
...
const stw_scl::C_SCLString C_OSCIOFileDataStructFiler::mhc_False = "FALSE";
const stw_scl::C_SCLString C_OSCIOFileDataStructFiler::mhc_True = "TRUE";
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCIOFileDataStructFiler::h_LoadStructs(std::vector<C_OSCIOFileDataStruct> & orc_Structs,
                                                 ...
                                                 const bool oq_RequireId, const bool oq_RequireSection)
{
   ...
   if (orc_XMLParser.SelectNodeChild(orc_SectionNodeName) == orc_SectionNodeName)
   {
      ...
      if (c_NodeChannel == orc_GroupNodeName)
      {
         do
         {
            C_OSCIOFileDataStruct c_Struct;
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCIOFileDataStructFiler::h_SaveStructs(const std::vector<C_OSCIOFileDataStruct> & orc_Structs,
                                                 const std::vector<C_OSCIOFileDataChannelUseCase> & orc_UseCases,
                                                 C_OSCXMLParserBase & orc_XMLParser,
                                                 const stw_scl::C_SCLString & orc_CurrentNodeName,
                                                 const stw_scl::C_SCLString & orc_SectionNodeName,
                                                 ...
                                                 const stw_scl::C_SCLString & orc_SingleNodeName)
{
   ...
   for (uint32 u32_ItStruct = 0UL; (u32_ItStruct < orc_Structs.size()) && (s32_Retval == C_NO_ERR); ++u32_ItStruct)
   {
      ...
      s32_Retval = C_OSCIOFileDataStructFiler::mh_SaveStruct(orc_Structs[u32_ItStruct], orc_UseCases, orc_XMLParser,
                                                             orc_GroupNodeName,
                                                             orc_SingleNodeName);
      if (s32_Retval == C_NO_ERR)
      {
...
/*! \brief  Parse simplest data type values
   ...
   \param[in]     orc_Type_Str      Original type string
   \param[in,out] orc_Content       Content to set
   \param[in,out] orc_XMLParser     XML with default state
   \param[in]     orc_AttributeName Attribute to look for value
*/
//----------------------------------------------------------------------------------------------------------------------
void C_OSCIOFileDataStructFiler::h_ParseSimplestTypeValue(const stw_scl::C_SCLString & orc_Type_Str,
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCIOFileDataStructFiler::h_GetTypeForSimplestTypeString(const stw_scl::C_SCLString & orc_Type_Str,
                                                                  C_OSCNodeDataPoolContent::E_Type & ore_Type)
{
   sint32 s32_Retval = C_NO_ERR;

   if (orc_Type_Str == "float64")
   {
      ore_Type = C_OSCNodeDataPoolContent::eFLOAT64;
   }
   else if (orc_Type_Str == "float32")
   {
      ore_Type = C_OSCNodeDataPoolContent::eFLOAT32;
   }
   else if (orc_Type_Str == "sint64")
   {
      ore_Type = C_OSCNodeDataPoolContent::eSINT64;
   }
   else if (orc_Type_Str == "sint32")
   {
      ore_Type = C_OSCNodeDataPoolContent::eSINT32;
   }
   else if (orc_Type_Str == "sint16")
   {
      ore_Type = C_OSCNodeDataPoolContent::eSINT16;
   }
   else if (orc_Type_Str == "sint8")
   {
      ore_Type = C_OSCNodeDataPoolContent::eSINT8;
   }
   else if (orc_Type_Str == "uint64")
   {
      ore_Type = C_OSCNodeDataPoolContent::eUINT64;
   }
   else if (orc_Type_Str == "uint32")
   {
      ore_Type = C_OSCNodeDataPoolContent::eUINT32;
   }
   else if (orc_Type_Str == "uint16")
   {
      ore_Type = C_OSCNodeDataPoolContent::eUINT16;
   }
   else if ((orc_Type_Str == "uint8") || (orc_Type_Str == "bool"))
   {
      ore_Type = C_OSCNodeDataPoolContent::eUINT8;
   }
   else
   {
      osc_write_log_error("Loading IO description", "Unexpected value for \"type\" attribute.");
      s32_Retval = C_CONFIG;
   }
   return s32_Retval;
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
stw_scl::C_SCLString C_OSCIOFileDataStructFiler::h_GetTypeString(const C_OSCNodeDataPoolContent::E_Type oe_Type)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCIOFileDataStructFiler::h_SaveSimpleValueAsAttribute(const stw_scl::C_SCLString & orc_Node,
                                                                C_OSCXMLParserBase & orc_XMLParser,
                                                                const C_OSCNodeDataPoolContent & orc_Content)
{
   ...
   {
      s32_Retval = C_CONFIG;
      osc_write_log_error("Saving IO description", "arrays not supported");
   }
   return s32_Retval;
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCIOFileDataStructFiler::h_SetType(C_OSCXMLParserBase & orc_XMLParser, C_OSCIOFileDataContent & orc_Content,
                                             ...
                                             const stw_scl::C_SCLString & orc_UseCaseForLog)
{
   ...
   if (s32_Retval == C_NO_ERR)
   {
      ...
      {
         orc_Content.SetComplexType(C_OSCIOFileDataContent::eCT_PLAIN);
      ...
      else if (orc_TypeStr == "enum")
      {
         ...
         {
            osc_write_log_error("Loading IO description", "Could not find \"base-type\" attribute.");
            s32_Retval = C_CONFIG;
         }
         if (s32_Retval == C_NO_ERR)
         {
            C_OSCNodeDataPoolContent::E_Type e_Type;
            s32_Retval = C_OSCIOFileDataStructFiler::h_GetTypeForSimplestTypeString(orc_BaseTypeStr, e_Type);
            orc_Content.SetType(e_Type);
            orc_Content.SetComplexType(C_OSCIOFileDataContent::eCT_ENUM);
            if (s32_Retval == C_NO_ERR)
            {
      ...
      else if (orc_TypeStr == "bitmask")
      {
         ...
         if (s32_Retval == C_NO_ERR)
         {
            ...
            s32_Retval = C_OSCIOFileDataStructFiler::h_GetTypeForSimplestTypeString(orc_BaseTypeStr, e_Type);
            orc_Content.SetType(e_Type);
            orc_Content.SetComplexType(C_OSCIOFileDataContent::eCT_BIT_MASK);
            if (s32_Retval == C_NO_ERR)
            {
   ...
   if (s32_Retval == C_NO_ERR)
   {
      ...
      if (c_EnumItemNode == "enum-item")
      {
         ...
         else
         {
            do
            {
               ...
               {
                  osc_write_log_error("Loading IO description", "\"enum-item\" node missing \"display\" attribute.");
                  s32_Retval = C_CONFIG;
               }
               if (s32_Retval == C_NO_ERR)
               {
                  ...
                  {
                     osc_write_log_error("Loading IO description", "\"enum-item\" node missing \"value\" attribute.");
                     s32_Retval = C_CONFIG;
                  }
               }
               if (s32_Retval == C_NO_ERR)
      ...
      else
      {
         if (orc_TypeStr == "enum")
         {
            osc_write_log_error("Loading IO description", "No \"enum-item\" node found for type enum.");
            s32_Retval = C_CONFIG;
         }
      }
   }
   ...
   if (s32_Retval == C_NO_ERR)
   {
      ...
      if (c_BitmaskItemNode == "bitmask-selection")
      {
         ...
         else
         {
            do
            {
               C_OSCIOFileDataContentBitmaskItem c_BitmaskItem;
      ...
      else
      {
         if (orc_TypeStr == "bitmask")
         {
            osc_write_log_error("Loading IO description", "No \"bitmask-selection\" node found for type bitmask.");
            s32_Retval = C_CONFIG;
         }
      }
   }
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCIOFileDataStructFiler::h_ParseAttributeIntoContent(C_OSCIOFileDataContent & orc_Content,
                                                               const C_OSCXMLParserBase & orc_XMLParser,
                                                               const stw_scl::C_SCLString & orc_AttributeName,
...
*/
//----------------------------------------------------------------------------------------------------------------------
C_OSCIOFileDataStructFiler::C_OSCIOFileDataStructFiler(void)
{
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCIOFileDataStructFiler::mh_LoadStruct(C_OSCIOFileDataStruct & orc_Struct, C_OSCXMLParserBase & orc_XMLParser,
                                                 const std::vector<C_OSCIOFileDataChannelUseCase> & orc_UseCases,
                                                 const stw_scl::C_SCLString & orc_GroupNodeName,
                                                 const stw_scl::C_SCLString & orc_SingleNodeName,
   ...
   if (orc_XMLParser.AttributeExists("type"))
   {
      ...
      if (c_Type == "struct")
      {
         ...
         if (s32_Retval == C_NO_ERR)
         {
            if (orc_XMLParser.AttributeExists("availability"))
            {
               ...
               s32_Retval = C_OSCIOFileDataStructFiler::mh_ParseAttributeAvailability(
      ...
      else
      {
         s32_Retval = mh_LoadDataElement(orc_Struct, orc_XMLParser, orc_UseCases, orc_Struct.c_UseCaseAvailabilities,
                                         orc_GroupNodeName, oq_RequireId);
      }
   }
   else
   {
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCIOFileDataStructFiler::mh_SaveStruct(const C_OSCIOFileDataStruct & orc_Struct,
                                                 const std::vector<C_OSCIOFileDataChannelUseCase> & orc_UseCases,
                                                 C_OSCXMLParserBase & orc_XMLParser,
                                                 const stw_scl::C_SCLString & orc_GroupNodeName,
                                                 const stw_scl::C_SCLString & orc_SingleNodeName)
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCIOFileDataStructFiler::mh_LoadDataElement(C_OSCIOFileDataElement & orc_Element,
                                                      C_OSCXMLParserBase & orc_XMLParser,
                                                      const std::vector<C_OSCIOFileDataChannelUseCase> & orc_UseCases,
                                                      ...
                                                      const bool oq_RequireId)
{
   ...
   if (s32_Retval == C_NO_ERR)
   {
      ...
      {
         const stw_scl::C_SCLString c_Availability = orc_XMLParser.GetAttributeString("availability");
         s32_Retval = C_OSCIOFileDataStructFiler::mh_ParseAttributeAvailability(orc_Element.c_UseCaseAvailabilities,
                                                                                c_Availability, orc_UseCases);
      }
      else
      {
   ...
   if (s32_Retval == C_NO_ERR)
   {
      ...
      s32_Retval = h_ParseAttributeIntoContent(orc_Element.c_InitialValue, orc_XMLParser, "initial-value", c_TypeStr,
                                               c_BaseTypeStr,
                                               orc_Element.GetComplexType() != C_OSCIOFileDataContent::eCT_BIT_MASK,
                                               orc_SingleNodeName);
      if (s32_Retval == C_NO_ERR)
      {
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCIOFileDataStructFiler::mh_SaveDataElement(const C_OSCIOFileDataElement & orc_Element,
                                                      const std::vector<C_OSCIOFileDataChannelUseCase> & orc_UseCases,
                                                      C_OSCXMLParserBase & orc_XMLParser,
                                                      const stw_scl::C_SCLString & orc_SingleNodeName)
{
   ...
   case C_OSCIOFileDataContent::eCT_BIT_MASK:
      {
         const std::vector<C_OSCIOFileDataContentBitmaskItem> & rc_BitmaskItems = orc_Element.GetBitmaskItems();
         ...
         {
            const C_OSCIOFileDataContentBitmaskItem & rc_Bitmask = rc_BitmaskItems[u32_It];
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCIOFileDataStructFiler::mh_ParseAttributeAvailability(std::vector<stw_types::uint32> & orc_Availability,
                                                                 ...
                                                                 const std::vector<C_OSCIOFileDataChannelUseCase> & orc_UseCases)
{
   ...
   else
   {
      ...
      for (sint32 s32_ItSplit = 0L; s32_ItSplit < c_SplittedString.GetLength(); ++s32_ItSplit)
      {
         ...
         for (uint32 u32_ItUseCase = 0UL; u32_ItUseCase < orc_UseCases.size(); ++u32_ItUseCase)
         {
            const C_OSCIOFileDataChannelUseCase & rc_CurUseCase = orc_UseCases[u32_ItUseCase];
...
*/
//----------------------------------------------------------------------------------------------------------------------
stw_types::sint32 C_OSCIOFileDataStructFiler::mh_GetAvailabilityString(
   const std::vector<stw_types::uint32> & orc_Availability,
   const std::vector<C_OSCIOFileDataChannelUseCase> & orc_UseCases, stw_scl::C_SCLString & orc_Output)
{
   ...
   for (uint32 u32_It = 0UL; u32_It < orc_Availability.size(); ++u32_It)
   {
      ...
      {
         const C_OSCIOFileDataChannelUseCase & rc_Availability = orc_UseCases[orc_Availability[u32_It]];
      ...
      {
         osc_write_log_error("Saving IO description",
                             stw_scl::C_SCLString(stw_scl::C_SCLString(
                                                     "Availability index ") +
...
/*! \brief  Set maximum value for type
   ...
   \param[in]     orc_Type_Str Type
   \param[in,out] orc_Content  Content to set
*/
//----------------------------------------------------------------------------------------------------------------------
void C_OSCIOFileDataStructFiler::mh_SetMaxValForType(const stw_scl::C_SCLString & orc_Type_Str,
                                                     C_OSCNodeDataPoolContent & orc_Content)
{
   if (orc_Type_Str == "float64")
   {
   ...
   else if (orc_Type_Str == "uint8")
   {
      orc_Content.SetValueU8(std::numeric_limits<uint8>::max());
   }
   else if (orc_Type_Str == "bool")
   {
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_OSCIOFileDataStructFiler::mh_SetMinValForType(const stw_scl::C_SCLString & orc_Type_Str,
                                                     C_OSCNodeDataPoolContent & orc_Content)
{
   if (orc_Type_Str == "float64")
   {
