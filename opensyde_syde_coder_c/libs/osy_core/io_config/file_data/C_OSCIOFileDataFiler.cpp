...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCIOFileDataFiler::h_LoadIODataFile(C_OSCIOFileDataBase & orc_IOData, const stw_scl::C_SCLString & orc_Path)
{
   ...
   if (TGL_FileExists(orc_Path) == true)
   {
      ...
      {
         s32_Retval = mh_LoadIOData(orc_IOData, c_XMLParser);
      }
      else
      {
   ...
   {
      osc_write_log_error("Loading IO description", "File \"" + orc_Path + "\" does not exist.");
      s32_Retval = C_RANGE;
   }
   return s32_Retval;
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCIOFileDataFiler::h_SaveIODataFile(const C_OSCIOFileDataBase & orc_IOData,
                                              const stw_scl::C_SCLString & orc_Path)
{
   ...
   if (TGL_FileExists(orc_Path) == true)
   {
      ...
      if (sn_Return != 0)
      {
         osc_write_log_error("Saving IO description", "Could not erase pre-existing file \"" + orc_Path + "\".");
         s32_Retval = C_RD_WR;
      }
   }
   if (s32_Retval == C_NO_ERR)
   {
      ...
      if (TGL_DirectoryExists(c_Folder) == false)
      {
         ...
         {
            osc_write_log_error("Saving IO description", "Could not create folder \"" + c_Folder + "\".");
            s32_Retval = C_RD_WR;
         }
      }
   }
   ...
   {
      C_OSCXMLParser c_XMLParser;
      s32_Retval = mh_SaveIOData(orc_IOData, c_XMLParser);
      if (s32_Retval == C_NO_ERR)
      {
         s32_Retval = c_XMLParser.SaveToFile(orc_Path);
         if (s32_Retval != C_NO_ERR)
         {
            osc_write_log_error("Saving IO description", "Could not write to file \"" + orc_Path + "\".");
            s32_Retval = C_RD_WR;
         }
      }
   }
...
*/
//----------------------------------------------------------------------------------------------------------------------
C_OSCIOFileDataFiler::C_OSCIOFileDataFiler(void)
{
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCIOFileDataFiler::mh_SaveIOData(const C_OSCIOFileDataBase & orc_IOData, C_OSCXMLParserBase & orc_XMLParser)
{
   sint32 s32_Retval = C_NO_ERR;

   orc_XMLParser.CreateNodeChild("opensyde-HALC-description");
   tgl_assert(orc_XMLParser.SelectRoot() == "opensyde-HALC-description");
   //File version
   ...
   //Return
   tgl_assert(orc_XMLParser.SelectNodeParent() == "opensyde-HALC-description");
   //Content version
   ...
   for (uint32 u32_ItDomain = 0UL; (u32_ItDomain < orc_IOData.GetDomainSize()) && (s32_Retval == C_NO_ERR);
        ++u32_ItDomain)
   {
      const C_OSCIOFileDataDomain * const pc_Domain = orc_IOData.GetDomainFileDataConst(u32_ItDomain);
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCIOFileDataFiler::mh_SaveIODomain(const C_OSCIOFileDataDomain & orc_IODataDomain,
                                             C_OSCXMLParserBase & orc_XMLParser)
{
   ...
   if (orc_IODataDomain.c_ChannelUseCases.size() > 0UL)
   {
      ...
      for (uint32 u32_ItCu = 0UL; (u32_ItCu < orc_IODataDomain.c_ChannelUseCases.size()) && (s32_Retval == C_NO_ERR);
           ++u32_ItCu)
      {
         const C_OSCIOFileDataChannelUseCase & rc_UseCase = orc_IODataDomain.c_ChannelUseCases[u32_ItCu];
         if (u32_ItCu == 0UL)
         {
            //First saves the type
            orc_XMLParser.SetAttributeString("type",
                                             C_OSCIOFileDataStructFiler::h_GetTypeString(rc_UseCase.c_Value.GetType()));
         }
   ...
   if (s32_Retval == C_NO_ERR)
   {
      s32_Retval = C_OSCIOFileDataStructFiler::h_SaveStructs(orc_IODataDomain.c_Parameters,
   ...
   if (s32_Retval == C_NO_ERR)
   {
      ...
      s32_Retval = C_OSCIOFileDataStructFiler::h_SaveStructs(orc_IODataDomain.c_InputValues,
                                                             orc_IODataDomain.c_ChannelUseCases, orc_XMLParser,
                                                             "values",
   ...
   if (s32_Retval == C_NO_ERR)
   {
      s32_Retval = C_OSCIOFileDataStructFiler::h_SaveStructs(orc_IODataDomain.c_OutputValues,
                                                             orc_IODataDomain.c_ChannelUseCases, orc_XMLParser,
                                                             "values",
   ...
   if (s32_Retval == C_NO_ERR)
   {
      s32_Retval = C_OSCIOFileDataStructFiler::h_SaveStructs(orc_IODataDomain.c_StatusValues,
                                                             orc_IODataDomain.c_ChannelUseCases, orc_XMLParser,
                                                             "values",
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCIOFileDataFiler::mh_LoadIOData(C_OSCIOFileDataBase & orc_IOData, C_OSCXMLParserBase & orc_XMLParser)
{
   sint32 s32_Retval = C_NO_ERR;

   if (orc_XMLParser.SelectRoot() == "opensyde-HALC-description")
   {
      //File version
      ...
      if (s32_Retval == C_NO_ERR)
      {
         if (orc_XMLParser.SelectNodeChild("content-version") == "content-version")
         {
            ...
            {
               osc_write_log_error("Loading IO description", "\"content-version\" could not be converted to a number.");
               s32_Retval = C_CONFIG;
            }
            if (s32_Retval == C_NO_ERR)
            {
         ...
         {
            osc_write_log_error("Loading IO description", "Could not find \"content-version\" node.");
            s32_Retval = C_CONFIG;
         }
      }
      if (s32_Retval == C_NO_ERR)
      {
         ...
         {
            osc_write_log_error("Loading IO description", "Could not find \"device-name\" node.");
            s32_Retval = C_CONFIG;
         }
      }
      if (s32_Retval == C_NO_ERR)
      {
         ...
         if (c_DomainNode == "domain")
         {
            do
            {
               C_OSCIOFileDataDomain c_Domain;
         ...
         {
            osc_write_log_error("Loading IO description", "Could not find \"domain\" node.");
            s32_Retval = C_CONFIG;
         }
      }
   }
   ...
   {
      osc_write_log_error("Loading IO description", "Could not find \"opensyde-HALC-description\" node.");
      s32_Retval = C_CONFIG;
   }
   return s32_Retval;
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCIOFileDataFiler::mh_LoadIODataDomain(C_OSCIOFileDataDomain & orc_IODataDomain,
                                                 C_OSCXMLParserBase & orc_XMLParser)
{
   sint32 s32_Retval = C_NO_ERR;
   ...
   {
      osc_write_log_error("Loading IO description", "Could not find \"id\" attribute.");
      s32_Retval = C_CONFIG;
   }
   if (s32_Retval == C_NO_ERR)
   {
      ...
      {
         osc_write_log_error("Loading IO description", "Could not find \"name\" node.");
         s32_Retval = C_CONFIG;
      }
   }
   if (s32_Retval == C_NO_ERR)
   ...
   if (s32_Retval == C_NO_ERR)
   {
      s32_Retval = C_OSCIOFileDataStructFiler::h_LoadStructs(orc_IODataDomain.c_Parameters, orc_XMLParser,
   ...
   if (s32_Retval == C_NO_ERR)
   {
      ...
      {
         s32_Retval = C_OSCIOFileDataStructFiler::h_LoadStructs(orc_IODataDomain.c_InputValues, orc_XMLParser,
         ...
         if (s32_Retval == C_NO_ERR)
         {
            s32_Retval = C_OSCIOFileDataStructFiler::h_LoadStructs(orc_IODataDomain.c_OutputValues, orc_XMLParser,
                                                                   orc_IODataDomain.c_ChannelUseCases,
         ...
         if (s32_Retval == C_NO_ERR)
         {
            s32_Retval = C_OSCIOFileDataStructFiler::h_LoadStructs(orc_IODataDomain.c_StatusValues, orc_XMLParser,
                                                                   orc_IODataDomain.c_ChannelUseCases,
      ...
      {
         osc_write_log_error("Loading IO description", "Could not find \"values\" node.");
         s32_Retval = C_CONFIG;
      }
   }
   return s32_Retval;
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCIOFileDataFiler::mh_LoadChannels(std::vector<stw_scl::C_SCLString> & orc_Channels,
                                             C_OSCXMLParserBase & orc_XMLParser)
{
   sint32 s32_Retval = C_NO_ERR;
   ...
   if (orc_XMLParser.SelectNodeChild("channels") == "channels")
   {
      ...
      {
         osc_write_log_error("Loading IO description", "Could not find \"count\" attribute.");
         s32_Retval = C_CONFIG;
      }
      if ((u32_ExpectedCount > 0UL) && (s32_Retval == C_NO_ERR))
      {
         ...
         if (c_NodeChannel == "channel")
         {
            do
            {
               ...
               {
                  osc_write_log_error("Loading IO description", "Could not find \"name\" attribute.");
                  s32_Retval = C_CONFIG;
               }
               if (s32_Retval == C_NO_ERR)
               {
         ...
         {
            osc_write_log_error("Loading IO description", "Could not find \"channel\" node.");
            s32_Retval = C_CONFIG;
         }
         //Check
         if (u32_ExpectedCount != orc_Channels.size())
         {
            ...
            osc_write_log_error("Loading IO description", c_Error.c_str());
            s32_Retval = C_CONFIG;
         }
      }
      if (s32_Retval == C_NO_ERR)
   ...
   {
      osc_write_log_error("Loading IO description", "Could not find \"channels\" node.");
      s32_Retval = C_CONFIG;
   }
   return s32_Retval;
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCIOFileDataFiler::mh_LoadChannelUseCases(std::vector<C_OSCIOFileDataChannelUseCase> & orc_ChannelUsecases,
                                                    C_OSCXMLParserBase & orc_XMLParser, const uint32 ou32_NumChannels)
{
   ...
   if (orc_XMLParser.SelectNodeChild("channel-use-cases") == "channel-use-cases")
   {
      ...
      if (orc_XMLParser.AttributeExists("type"))
      {
         ...
         s32_Retval = C_OSCIOFileDataStructFiler::h_GetTypeForSimplestTypeString(c_TypeStr, e_Type);
         c_Value.SetType(e_Type);
      }
      else
      {
         osc_write_log_error("Loading IO description", "Could not find \"type\" attribute.");
         s32_Retval = C_CONFIG;
      }
      if (s32_Retval == C_NO_ERR)
      {
         ...
         if (c_NodeChannel == "channel-use-case")
         {
            do
            {
               C_OSCIOFileDataChannelUseCase c_UseCase;
               if (orc_XMLParser.AttributeExists("id"))
               {
               ...
               if (s32_Retval == C_NO_ERR)
               {
                  ...
                  {
                     osc_write_log_error("Loading IO description", "Could not find \"display\" attribute.");
                     s32_Retval = C_CONFIG;
                  }
               }
               if (orc_XMLParser.AttributeExists("value"))
               {
                  ...
                  C_OSCIOFileDataStructFiler::h_ParseSimplestTypeValue(c_TypeStr, c_UseCase.c_Value, orc_XMLParser,
                                                                       "value");
               }
               else
               {
                  osc_write_log_error("Loading IO description", "Could not find \"value\" attribute.");
                  s32_Retval = C_CONFIG;
               }
               if (s32_Retval == C_NO_ERR)
               {
                  ...
                  {
                     osc_write_log_error("Loading IO description", "Could not find \"availability\" attribute.");
                     s32_Retval = C_CONFIG;
                  }
               }
               if (s32_Retval == C_NO_ERR)
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCIOFileDataFiler::mh_LoadAvailability(const stw_scl::C_SCLString & orc_AvailabilityString,
                                                 ...
                                                 const uint32 ou32_NumChannels)
{
   ...
   sint32 s32_Retval = C_OSCIOFileDataFiler::mh_SplitAvailabilityString(orc_AvailabilityString, c_SubElements);

   orc_Availability.clear();
   if (s32_Retval == C_NO_ERR)
   {
      s32_Retval = C_OSCIOFileDataFiler::mh_ParseAvailabilityStringSubElements(c_SubElements, orc_Availability,
                                                                               ou32_NumChannels);
   }
   return s32_Retval;
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCIOFileDataFiler::mh_SplitAvailabilityString(const stw_scl::C_SCLString & orc_AvailabilityString,
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCIOFileDataFiler::mh_ParseAvailabilityStringSubElements(
   const std::vector<stw_scl::C_SCLString> & orc_SubElements,
   std::vector<C_OSCIOFileDataChannelAvailability> & orc_Availability, const uint32 ou32_NumChannels)
{
   sint32 s32_Retval = C_NO_ERR;
   ...
   for (uint32 u32_ItSubStr = 0UL; (u32_ItSubStr < orc_SubElements.size()) && (s32_Retval == C_NO_ERR); ++u32_ItSubStr)
   {
      ...
      if (rc_CurSubStr == "all")
      {
         ...
         {
            C_OSCIOFileDataChannelAvailability c_Availability;
      ...
      else
      {
            ...
            else
            {
               ...
               if (cn_CurChar == '-')
               {
                  ...
                  else
                  {
                     ...
                     s32_Retval = C_OSCIOFileDataFiler::mh_ConvertStringToNumber(c_Number, sn_NumberTmp);
                     c_Number = "";
               ...
               {
                  //Handle vector
                  s32_Retval = C_OSCIOFileDataFiler::mh_HandleNumberSection(c_Number, c_FoundNumbers,
         ...
         if (s32_Retval == C_NO_ERR)
         {
            s32_Retval = C_OSCIOFileDataFiler::mh_HandleNumberSectionEnd(c_FoundNumbers, q_IsGroupSection,
                                                                         orc_Availability,
                                                                         ou32_NumChannels);
         }
      }
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCIOFileDataFiler::mh_ConvertStringToNumber(const stw_scl::C_SCLString & orc_Number, sintn & orsn_Number)
{
   sint32 s32_Retval = C_NO_ERR;
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCIOFileDataFiler::mh_HandleNumberSection(stw_scl::C_SCLString & orc_Number,
                                                    ...
                                                    const stw_scl::C_SCLString & orc_Section)
{
   ...
   //Handle any left over number
   s32_Retval = C_OSCIOFileDataFiler::mh_ConvertStringToNumber(orc_Number, sn_NumberTmp);
   orc_Number = "";
   if (s32_Retval == C_NO_ERR)
   {
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCIOFileDataFiler::mh_HandleNumberSectionEnd(const std::vector<sintn> & orc_FoundNumbers,
...
*/
//----------------------------------------------------------------------------------------------------------------------
stw_scl::C_SCLString C_OSCIOFileDataFiler::mh_GetAvailabilityString(
   const std::vector<C_OSCIOFileDataChannelAvailability> & orc_Availability)
{
   ...
   {
      const C_OSCIOFileDataChannelAvailability & rc_Avail = orc_Availability[u32_ItAva];
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCIOFileDataFiler::mh_SaveUseCase(const C_OSCIOFileDataChannelUseCase & orc_UseCase,
                                            C_OSCXMLParserBase & orc_XMLParser)
{
   sint32 s32_Retval;
   ...
   s32_Retval = C_OSCIOFileDataStructFiler::h_SaveSimpleValueAsAttribute("value", orc_XMLParser, orc_UseCase.c_Value);
   orc_XMLParser.SetAttributeString("availability",
                                    C_OSCIOFileDataFiler::mh_GetAvailabilityString(orc_UseCase.c_Availability));
