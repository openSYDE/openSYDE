...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCCanOpenManagerFiler::mh_LoadManagerMappedSignals(
   std::vector<C_OSCCanOpenManagerMappableSignal> & orc_Config, C_OSCXMLParserBase & orc_XMLParser)
{
   ...
   if (orc_XMLParser.SelectNodeChild("mappable-signals") == "mappable-signals")
   {
      ...
      if (s32_Retval == C_NO_ERR)
      {
         stw_scl::C_SCLString c_NodeName = orc_XMLParser.SelectNodeChild("mappable-signal");
...
*/
//----------------------------------------------------------------------------------------------------------------------
sint32 C_OSCCanOpenManagerFiler::mh_LoadManagerMappedSignal(C_OSCCanOpenManagerMappableSignal & orc_Config,
                                                            C_OSCXMLParserBase & orc_XMLParser)
{
   sint32 s32_Retval = orc_XMLParser.GetAttributeBoolError("is-auto-min-max-used", orc_Config.q_AutoMinMaxUsed);
