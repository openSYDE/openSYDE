...
public:
   ...
   stw_types::sint32 CheckErrorDeviceCoNodeId(const C_OSCCanInterfaceId & orc_DeviceId,
                                              bool * const opq_CoNodeIDConflict, bool * const opq_CoNodeIDInvalid,
                                              const bool oq_CheckDeviceToDeviceErrors) const;
   stw_types::sint32 CheckErrorDeviceHeartbeat(const C_OSCCanInterfaceId & orc_DeviceId,
