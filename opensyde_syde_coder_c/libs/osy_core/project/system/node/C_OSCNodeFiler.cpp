...
*/
//-----------------------------------------------------------------------------
sint32 C_OSCNodeFiler::h_LoadNode(const uint16 ou16_XmlFormatVersion, C_OSCNode & orc_Node,
...
*/
//-----------------------------------------------------------------------------
void C_OSCNodeFiler::h_SaveNode(const C_OSCNode & orc_Node, C_OSCXMLParserBase & orc_XMLParser)
{
                                              ...
                                              C_OSCXMLParserBase & orc_XMLParser)
{
   ...
   C_SCLString c_CurNodeComProtocol = orc_XMLParser.SelectNodeChild("com-protocol");
...
*/
//-----------------------------------------------------------------------------
void C_OSCNodeFiler::h_SaveNodeComProtocols(const std::vector<C_OSCCanProtocol> & orc_NodeComProtocols,
                                            C_OSCXMLParserBase & orc_XMLParser)
{
...
*/
//-----------------------------------------------------------------------------
sint32 C_OSCNodeFiler::h_LoadNodeComProtocol(C_OSCCanProtocol & orc_NodeComProtocol, C_OSCXMLParserBase & orc_XMLParser)
{
   sint32 s32_Retval = C_NO_ERR;
...
*/
//-----------------------------------------------------------------------------
void C_OSCNodeFiler::h_SaveNodeComProtocol(const C_OSCCanProtocol & orc_NodeComProtocol,
                                           C_OSCXMLParserBase & orc_XMLParser)
{
...
*/
//-----------------------------------------------------------------------------
sint32 C_OSCNodeFiler::h_LoadNodeComMessageContainers(
   std::vector<C_OSCCanMessageContainer> & orc_NodeComMessageContainers, C_OSCXMLParserBase & orc_XMLParser)
{
   sint32 s32_Retval = C_NO_ERR;

   C_SCLString c_CurNodeComMessageContainer = orc_XMLParser.SelectNodeChild("com-message-container");
...
*/
//-----------------------------------------------------------------------------
void C_OSCNodeFiler::h_SaveNodeComMessageContainers(
...
*/
//-----------------------------------------------------------------------------
sint32 C_OSCNodeFiler::h_LoadNodeComMessageContainer(C_OSCCanMessageContainer & orc_NodeComMessageContainer,
                                                     C_OSCXMLParserBase & orc_XMLParser)
{
   sint32 s32_Retval = C_NO_ERR;
...
*/
//-----------------------------------------------------------------------------
void C_OSCNodeFiler::h_SaveNodeComMessageContainer(const C_OSCCanMessageContainer & orc_NodeComMessageContainer,
                                                   C_OSCXMLParserBase & orc_XMLParser)
{
...
*/
//-----------------------------------------------------------------------------
sint32 C_OSCNodeFiler::h_LoadNodeComMessages(std::vector<C_OSCCanMessage> & orc_NodeComMessages,
                                             C_OSCXMLParserBase & orc_XMLParser)
{
   sint32 s32_Retval = C_NO_ERR;

   C_SCLString c_CurNodeComMessage = orc_XMLParser.SelectNodeChild("com-message");
...
*/
//-----------------------------------------------------------------------------
void C_OSCNodeFiler::h_SaveNodeComMessages(const std::vector<C_OSCCanMessage> & orc_NodeComMessages,
                                           C_OSCXMLParserBase & orc_XMLParser)
{
...
*/
//-----------------------------------------------------------------------------
sint32 C_OSCNodeFiler::h_LoadNodeComMessage(C_OSCCanMessage & orc_NodeComMessage, C_OSCXMLParserBase & orc_XMLParser)
{
   sint32 s32_Retval = C_NO_ERR;
...
*/
//-----------------------------------------------------------------------------
void C_OSCNodeFiler::h_SaveNodeComMessage(const C_OSCCanMessage & orc_NodeComMessage,
                                          C_OSCXMLParserBase & orc_XMLParser)
{
...
*/
//-----------------------------------------------------------------------------
sint32 C_OSCNodeFiler::h_LoadNodeComSignals(std::vector<C_OSCCanSignal> & orc_NodeComSignals,
                                            C_OSCXMLParserBase & orc_XMLParser)
{
   sint32 s32_Retval = C_NO_ERR;

   C_SCLString c_CurNodeComSignal = orc_XMLParser.SelectNodeChild("com-signal");
...
*/
//-----------------------------------------------------------------------------
void C_OSCNodeFiler::h_SaveNodeComSignals(const std::vector<C_OSCCanSignal> & orc_NodeComSignals,
                                          C_OSCXMLParserBase & orc_XMLParser)
{
...
*/
//-----------------------------------------------------------------------------
sint32 C_OSCNodeFiler::h_LoadNodeComSignal(C_OSCCanSignal & orc_NodeComSignal, C_OSCXMLParserBase & orc_XMLParser)
{
   sint32 s32_Retval = C_NO_ERR;
...
*/
//-----------------------------------------------------------------------------
void C_OSCNodeFiler::h_SaveNodeComSignal(const C_OSCCanSignal & orc_NodeComSignal, C_OSCXMLParserBase & orc_XMLParser)
{
...
*/
//-----------------------------------------------------------------------------
C_SCLString C_OSCNodeFiler::h_CommunicationProtocolToString(const C_OSCCanProtocol::E_Type & ore_CommunicationProtocol)
{
...
*/
//-----------------------------------------------------------------------------
sint32 C_OSCNodeFiler::h_StringToCommunicationProtocol(const C_SCLString & orc_String,
...
sint32 C_OSCNodeFiler::mh_LoadProperties(C_OSCNodeProperties & orc_NodeProperties, C_OSCXMLParserBase & orc_XMLParser)
{
   ...
   if (orc_XMLParser.SelectNodeChild("properties") == "properties")
   {
          ...
          (s32_Retval == C_NO_ERR))
      {
         ...
         if (c_CurNode == "communication-interface")
         {
            do
            {
               ...
               if (orc_XMLParser.SelectNodeChild("communication-protocol") == "communication-protocol")
               {
                  c_ComInterface.q_IsComProtocolL2Enabled = orc_XMLParser.GetAttributeBool("layer-2-available");
                  c_ComInterface.q_IsComProtocolECeSEnabled = orc_XMLParser.GetAttributeBool("eces-available");
                  c_ComInterface.q_IsComProtocolCANOpenSafetyEnabled = orc_XMLParser.GetAttributeBool(
                     "can-open-safety-available");
                  //Return
                  tgl_assert(orc_XMLParser.SelectNodeParent() == "communication-interface");
               }
               else
               {
                  osc_write_log_error("Loading node definition",
                                      "Could not find \"communication-interface\".\"communication-protocol\" node.");
                  s32_Retval = C_CONFIG;
               }
               //Bus
      ...
      if (orc_XMLParser.SelectNodeChild("open-syde-server-settings") == "open-syde-server-settings")
      {
         ...
         {
            orc_NodeProperties.c_OpenSYDEServerSettings.u8_MaxParallelTransmissions = 16;
         }
         ...
         {
            orc_NodeProperties.c_OpenSYDEServerSettings.u16_MaxMessageBufferTx = 512U;
         }
         ...
         {
            orc_NodeProperties.c_OpenSYDEServerSettings.u16_MaxRoutingMessageBufferRx = 512U;
         }
                                       ...
                                       C_OSCXMLParserBase & orc_XMLParser)
{
        ...
        ++u32_ItComInterface)
   {
      ...
      orc_XMLParser.SetAttributeBool("layer-2-available", rc_CurComInterface.q_IsComProtocolL2Enabled);
      orc_XMLParser.SetAttributeBool("eces-available", rc_CurComInterface.q_IsComProtocolECeSEnabled);
      orc_XMLParser.SetAttributeBool("can-open-safety-available",
                                     rc_CurComInterface.q_IsComProtocolCANOpenSafetyEnabled);
      //Return
      tgl_assert(orc_XMLParser.SelectNodeParent() == "communication-interface");
                                           ...
                                           C_OSCXMLParserBase & orc_XMLParser)
{
   ...
   {
      C_SCLString c_CurNode = orc_XMLParser.SelectNodeChild("application");
...
*/
//-----------------------------------------------------------------------------
sint32 C_OSCNodeFiler::mh_LoadDataPools(const uint16 ou16_XmlFormatVersion, C_OSCNode & orc_Node,
                                        C_OSCXMLParserBase & orc_XMLParser)
{
   sint32 s32_Retval = C_NO_ERR;
   ...
   {
      C_SCLString c_CurNode = orc_XMLParser.SelectNodeChild("data-pool");
      if (c_CurNode == "data-pool")
      {
         do
         {
            ...
            s32_Retval =
               C_OSCNodeDataPoolFiler::h_LoadDataPool(ou16_XmlFormatVersion, c_CurDataPool, orc_XMLParser);
            if (s32_Retval != C_NO_ERR)
            {
               break;
            }
...
*/
//-----------------------------------------------------------------------------
void C_OSCNodeFiler::mh_SaveDataPools(const std::vector<C_OSCNodeDataPool> & orc_NodeDataPools,
                                      C_OSCXMLParserBase & orc_XMLParser)
{
   ...
   for (uint32 u32_ItDataPool = 0; u32_ItDataPool < orc_NodeDataPools.size(); ++u32_ItDataPool)
   {
      ...
      C_OSCNodeDataPoolFiler::h_SaveDataPool(orc_NodeDataPools[u32_ItDataPool], orc_XMLParser);
      //Return
      tgl_assert(orc_XMLParser.SelectNodeParent() == "data-pools");
   }
   //Return
                                              ...
                                              C_OSCNodeProperties::E_FlashLoaderProtocol & ore_Type)
{
   ...
   {
      osc_write_log_error("Loading node definition",
                          "Invalid value for \"propertiesr\".\"flash-loader\":" + orc_String);
      s32_Retval = C_RANGE;
   }
...
*/
//-----------------------------------------------------------------------------
C_SCLString C_OSCNodeFiler::mh_CommunicationByteOrderToString(
...
*/
//-----------------------------------------------------------------------------
sint32 C_OSCNodeFiler::mh_StringToCommunicationByteOrder(const C_SCLString & orc_String,
...
*/
//-----------------------------------------------------------------------------
C_SCLString C_OSCNodeFiler::mh_NodeComMessageTxMethodToString(
...
*/
//-----------------------------------------------------------------------------
sint32 C_OSCNodeFiler::mh_StringToNodeComMessageTxMethod(const C_SCLString & orc_String,
