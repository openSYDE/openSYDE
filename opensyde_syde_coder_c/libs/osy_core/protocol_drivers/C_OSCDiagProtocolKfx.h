...
private:
   ...
   C_OSCDiagProtocolKfx(const C_OSCDiagProtocolKfx & orc_Souce);               //not implemented -> prevent copying
   C_OSCDiagProtocolKfx & operator = (const C_OSCDiagProtocolKfx & orc_Souce); //not implemented -> prevent assignment
