...
class CMONPROTOCOL_PACKAGE C_CMONProtocolOpenSYDE :
...
private:
   ...
   stw_scl::C_SCLString m_DataIdentifierAndDataToText(const bool oq_IsWrite,
                                                      const stw_types::uint16 ou16_DataIdentifier,
                                                      const bool oq_IsResponse, const stw_types::uint8 ou8_PayloadSize,
                                                      const stw_types::uint8 * const opu8_Payload) const;
   stw_scl::C_SCLString m_RoutineDataToText(const stw_types::uint16 ou16_RoutineIdentifier, const bool oq_IsResponse,
