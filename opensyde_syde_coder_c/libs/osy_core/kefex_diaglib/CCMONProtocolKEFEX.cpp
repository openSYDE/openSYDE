...
static const uint8 mu8_KFX_PROTOCOL_SRR                          = 0x01U;
static const uint8 mu8_KFX_PROTOCOL_ECRR                         = 0x02U;
static const uint8 mu8_KFX_PROTOCOL_TCRR                         = 0x03U;
static const uint8 mu8_KFX_PROTOCOL_TCRR_TIMESTAMPED             = 0x04U;
static const uint8 mu8_KFX_PROTOCOL_ABORT_INDIVIDUAL_RESPONSE    = 0x0AU;
static const uint8 mu8_KFX_PROTOCOL_ABORT_INDIVIDUAL_RESPONSE_HS = 0x0BU;
static const uint8 mu8_KFX_PROTOCOL_ABORT_ALL_RESPONSES          = 0x0CU;
static const uint8 mu8_KFX_PROTOCOL_ABORT_ALL_RESPONSES_HS       = 0x0DU;
static const uint8 mu8_KFX_PROTOCOL_IMMEDIATE_WRITE_HS           = 0x0FU;
static const uint8 mu8_KFX_PROTOCOL_LOGON_HS                     = 0x11U;
static const uint8 mu8_KFX_PROTOCOL_LOGOFF_HS                    = 0x15U;
static const uint8 mu8_KFX_PROTOCOL_SERVICE_READ                 = 0x16U;
static const uint8 mu8_KFX_PROTOCOL_SERVICE_WRITE                = 0x17U;
static const uint8 mu8_KFX_PROTOCOL_STARTUP_INDICATION           = 0x1AU;
static const uint8 mu8_KFX_PROTOCOL_READ_EEPROM                  = 0x20U;
static const uint8 mu8_KFX_PROTOCOL_READ_FLASH_EEPROM            = 0x21U;
static const uint8 mu8_KFX_PROTOCOL_READ_SRAM                    = 0x22U;
static const uint8 mu8_KFX_PROTOCOL_READ_EPROM                   = 0x23U;
static const uint8 mu8_KFX_PROTOCOL_WRITE_EEPROM_HS              = 0x27U;
static const uint8 mu8_KFX_PROTOCOL_WRITE_FLASH_EEPROM_HS        = 0x29U;
static const uint8 mu8_KFX_PROTOCOL_WRITE_SRAM_HS                = 0x2BU;
static const uint8 mu8_KFX_PROTOCOL_UPDATE_TASK                  = 0x2EU;
static const uint8 mu8_KFX_PROTOCOL_UPDATE_TASK_HS               = 0x2FU;
static const uint8 mu8_KFX_PROTOCOL_WRITE_EEPROM_SSL             = 0x30U;
static const uint8 mu8_KFX_PROTOCOL_IWR_FF                       = 0x40U;
static const uint8 mu8_KFX_PROTOCOL_IWR_FC                       = 0x40U;
static const uint8 mu8_KFX_PROTOCOL_IWR_CF                       = 0x41U;
static const uint8 mu8_KFX_PROTOCOL_SRR_FF                       = 0x42U;
static const uint8 mu8_KFX_PROTOCOL_SRR_FC                       = 0x42U;
static const uint8 mu8_KFX_PROTOCOL_SRR_CF                       = 0x43U;
...
uint16 C_CMONProtocolKEFEX::GetBaseID(void) const
{
...
void C_CMONProtocolKEFEX::SetBaseID(const uint16 ou16_BaseID)
{
...
{
   this->mu16_KFXBaseID     = static_cast<uint16>(orc_IniFile.ReadInteger(orc_Section, "PP_KFX_BASE_ID",
                                                  this->mu16_KFXBaseID));
   this->mu16_KFXListOffset = static_cast<uint16>(orc_IniFile.ReadInteger(orc_Section, "PP_KFX_LIST_OFFSET",
...
C_SCLString C_CMONProtocolKEFEX::m_KFXIndexAndErrorToString(const charn * const opcn_Text, const uint16 ou16_Index,
...
C_SCLString C_CMONProtocolKEFEX::m_KFXTextAndValueToString(const charn * const opcn_Text,
                                                           const uint32 ou32_Value) const
{
   C_SCLString c_Help;
   if (mq_Decimal == true)
   {
...
C_SCLString C_CMONProtocolKEFEX::MessageToString(const T_STWCAN_Msg_RX & orc_Msg) const
{
   ...
   if ((orc_Msg.u32_ID >= static_cast<uint32>(mu16_KFXBaseID)) &&
       (orc_Msg.u32_ID <= ((static_cast<uint32>(mu16_KFXBaseID)) + 0x1FFU)))
   {
      //it is a KFX protocol message !
      uint8 u8_Sender;
      uint8 u8_Receiver;
      uint16 u16_Time;
      uint16 u16_Hysteresis;
      uint32 u32_Address;
      uint32 u32_Size;
      uint16 u16_Value;
      bool q_Request;
         ...
         else
         {
            ...
            case mu8_KFX_PROTOCOL_ECRR:
               ...
               else
               {
                  ...
                  {
                     f64_Help = (static_cast<float64>(u16_UpperHyst) / 10.0);
                  }
                  else //30..127 -> 3% .. 100%
                  {
                     f64_Help = (static_cast<float64>(u16_UpperHyst) - 27.0);
                  }
                  ...
                  {
                     f64_Help = (static_cast<float64>(u16_LowerHyst) / 10.0);
                  }
                  else //30..127 -> 3% .. 100%
                  {
                     f64_Help = (static_cast<float64>(u16_LowerHyst) - 27.0);
                  }
                  c_Help2 += C_SCLString::FloatToStr(f64_Help) + "%";
            ...
            case mu8_KFX_PROTOCOL_WRITE_SRAM_HS:
               ...
               else
               {
                  ...
                  {
                     c_Help += m_GetByteAsStringFormat(static_cast<uint8>(u16_Value));
                  }
               }
               c_Text += c_Help;
               break;
