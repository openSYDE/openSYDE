...
public:
   ...
   void SetConciseEntry(const stw_types::uint16 ou16_Index, const stw_types::uint8 ou8_SubIndex,
                        const std::vector<stw_types::uint8> & orc_Payload, const stw_scl::C_SCLString & orc_Comment);
   void SetConciseEntry(const stw_types::uint16 ou16_Index, const stw_types::uint8 ou8_SubIndex,
                        const stw_types::uint8 ou8_Value, const stw_scl::C_SCLString & orc_Comment);
   void SetConciseEntry(const stw_types::uint16 ou16_Index, const stw_types::uint8 ou8_SubIndex,
                        const stw_types::uint16 ou16_Value, const stw_scl::C_SCLString & orc_Comment);
   void SetConciseEntry(const stw_types::uint16 ou16_Index, const stw_types::uint8 ou8_SubIndex,
                        const stw_types::uint32 ou32_Value, const stw_scl::C_SCLString & orc_Comment);
...
protected:
   ...
   static void mh_AddIncludes(stw_scl::C_SCLStringList & orc_Data, const C_OSCNodeDataPool & orc_Datapool,
                              const stw_types::uint8 ou8_InterfaceIndex, const bool oq_IncludeDataPool);
   ...
   static void mh_AddManagerConfig(stw_scl::C_SCLStringList & orc_Data, const stw_scl::C_SCLString & orc_DatapoolName,
                                   ...
                                   const bool oq_TxExists, const bool oq_RxExists, const bool oq_ReferenceDataPool);
   static void mh_CollectDeviceSpecificConciseData(std::vector<C_OSCExportCanOpenConciseEntry> & orc_ConciseEntries,
                                                   ...
                                                   const stw_types::uint8 ou8_ManagerID);
