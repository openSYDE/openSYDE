...
private:
   ...
   static stw_scl::C_SCLString mh_GetStringForDbConfig(const C_OSCHalcConfigChannel::E_DataBlockConfig oe_Config);
   ...
   static stw_types::sint32 mh_LoadIODomain(C_OSCHalcConfigDomain & orc_IODomain, C_OSCXMLParserBase & orc_XMLParser);
   static stw_types::sint32 mh_LoadIOChannel(C_OSCHalcConfigChannel & orc_IOChannel,
                                             C_OSCXMLParserBase & orc_XMLParser);
   static stw_types::sint32 mh_LoadIODatablockConfigs(
      std::vector<C_OSCHalcConfigChannel::E_DataBlockConfig> & orc_DatablockConfigs,
      C_OSCXMLParserBase & orc_XMLParser);
